...
public enum AnalyticsEngine {
    ...
    public enum Rest {
        ...
        /// Gilbert Fold / Android parity: low-deep nights must not keep Rest inflated.
        public static let deepFloorFactor: Double = 0.14
        ...
        // Weights match Android RestScorer (CROSS_PLATFORM contract).
        ...
        public static func durationQualityFactor(_ restorativeShare: Double) -> Double {
        ...
        public static func composite(tstSeconds: Double,
            ...
            let aligned = max(0.0, min(1.0, weighted * restWhoopAlignScale))
            return (aligned * 10000.0).rounded() / 100.0
        }
