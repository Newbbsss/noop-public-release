...
public enum BatteryEstimator {
    ...
    /// Pick rated life by family — mirrors Android `ratedLifeHours(whoop5Family)`.
    public static func ratedLifeHours(whoop5Family: Bool) -> Double {
        whoop5Family ? ratedLifeHoursWhoop5 : ratedLifeHoursWhoop4
    }
