...
public enum HRVAnalyzer {
    ...
    public static func rejectEctopic(_ nn: [Double], threshold: Double = ectopicThreshold) -> [Double] {
    ...
    public static func cleanRR(_ rr: [Double], ectopicThreshold: Double? = nil) -> [Double] {
        rejectEctopic(rangeFilter(rr), threshold: ectopicThreshold ?? Self.ectopicThreshold)
    }
    ...
    public static func analyze(rawRR: [Double], maxRejectedFraction: Double? = nil,
                               ectopicThreshold: Double? = nil) -> HRVResult {
        let nInput = rawRR.count
        let clean = cleanRR(rawRR, ectopicThreshold: ectopicThreshold)
