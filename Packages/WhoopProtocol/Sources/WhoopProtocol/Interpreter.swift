...
private func decodeWhoop5HistoricalV2021(_ frame: [UInt8], fb: FieldBuilder, version: Int, payloadEnd: Int?) {
    ...
    //
    // EVIDENCE (why 25, not 50): across captured 2140-B buffers, active blocks carry sampleCount=25 and
    // sample slots 25..49 are zero padding. Wavelength identity remains open — no red/ir labels.
