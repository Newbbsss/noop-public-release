...
object BatteryEstimator {
    ...
    /** Rated-life fallback from model family (5/MG vs 4/3). Prefer over a stale live `whoop5` boolean
     *  that clears on disconnect and wrongly shrinks MG estimates to the 4.5-day pack. */
    fun ratedLifeHours(whoop5Family: Boolean): Double =
        if (whoop5Family) ratedLifeHoursWhoop5 else ratedLifeHoursWhoop4
