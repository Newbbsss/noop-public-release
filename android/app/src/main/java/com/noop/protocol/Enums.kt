 ...
 * REBOOT_STRAP is the one soft reboot allowed (user-gated, keeps stored history) — #166 / 8.6.1.
 */
enum class CommandNumber(val rawValue: Int) {
    ...
    // REBOOT_STRAP (29): non-destructive soft reboot — keeps stored history, re-advertises after boot.
    // User-initiated only (Devices → Restart strap). NOOP 8.6.1 / #166. Not factory wipe / DFU.
    REBOOT_STRAP(29),
