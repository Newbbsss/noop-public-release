...
// â€” macOS, Android, the repo CHANGELOG.md â€” tells the exact same story.
//
// Icon mapping (SF Symbol â†’ Material, all verified to resolve in material-icons-extended):
//   flask           â†’ Icons.Outlined.Science        (independent / experimental)
//   checkmark.seal  â†’ Icons.Outlined.VerifiedUser   (the supported path)
//   hourglass       â†’ Icons.Outlined.HourglassEmpty (scores build over time)
//   lock.shield     â†’ Icons.Outlined.Shield         (everything stays on-device)
...
object AppChangelog {
    ...
    val releases: List<Release> = listOf(
        ...
        Release(
            ...
            date = "July 2026",
            items = listOf(
                "**[improve]** Hold-+ dial: press-spring bloom Â· ~220ms spokes Â· Workout (no Up=).",
                "**[improve]** Dial spokes: Nutrition replaces Strength Â· Water sip restored.",
                "**[improve]** Light mid-tone paper Â· quieter day-cycle wash; Settings under-bar soft edge.",
                "**[chore]** Compile Guardian one gate + publish 8.6.153/423.",
            ),
        ),
        Release(
            version = "8.6.152",
            title = "Themes light Â· Today clouds Â· Friends network",
            date = "July 2026",
            items = listOf(
                "**[improve]** Light mode packs: Palette.schemeIsLight Â· frost/tracks/liquid heroes.",
                "**[improve]** Today: top-band clouds scroll-fade Â· fast dial Â· EffortÂ·ChargeÂ·Rest Â· past-day Charge.",
                "**[improve]** Friends network (invite/share skeleton); scrub AI Store/Tailscale outside Friends.",
                "**[chore]** Compile Guardian one gate + publish 8.6.152/422.",
            ),
        ),
        Release(
            version = "8.6.151",
            title = "400 grind Â· Quick Start order Â· under-bar frost Â· unit pair",
            date = "July 2026",
            items = listOf(
                "**[improve]** Quick Start order: pair â†’ permissions â†’ night â†’ Cycle (#226).",
                "**[improve]** Health/Live under-bar frost regression guard (#204).",
                "**[improve]** Vessel value+scale caption pair documented (#285).",
                "**[chore]** Compile Guardian one gate + publish 8.6.151/421.",
            ),
        ),
        Release(
            version = "8.6.150",
            title = "400 grind Â· night tip ceiling Â· About honesty Â· light aura",
            date = "July 2026",
            items = listOf(
                "**[improve]** Night stress tip ceiling 1.35â†’1.0 closer to WHOOP (#83/#209).",
                "**[improve]** Failed update check recoverable next step (#326).",
                "**[improve]** About: privacy/SAFEGUARDS Â· MAIN vs DEBUG Â· .noopbak before upgrade (#327â€“329).",
                "**[improve]** Light-pack + aura more visible (#242).",
                "**[chore]** Compile Guardian one gate + publish 8.6.150/420.",
            ),
        ),
        Release(
            version = "8.6.149",
            title = "400 grind Â· skin family Â· sync hold Â· Connections Â· reduce-motion teach",
            date = "July 2026",
            items = listOf(
                "**[improve]** Skin temp absolute vs Î” baseline family labels (#206).",
                "**[improve]** Syncingâ€¦ scores hold cue Â· Keep/Merge twin wording (#275/#284).",
                "**[improve]** Connections three pairing stories Â· phone vs strap primary (#274/#266).",
                "**[improve]** Reduce-motion hold+ teach line Â· Test Centre DEBUG-only label (#358/#372/#251/#363).",
                "**[improve]** Sleep V2 opt-in documented only â€” no invented stages (#97).",
                "**[chore]** Process hygiene check-offs Â· compile gate + publish 8.6.149/419.",
            ),
        ),
        Release(
            version = "8.6.148",
            title = "400 grind Â· Stress units Â· Fitness Age Â· Lab Book Â· Help Â· sync honesty",
            date = "July 2026",
            items = listOf(
                "**[improve]** Stress skin copy follows Â°C/Â°F Â· Advanced HRV 12s/45s cadence (#190/#196).",
                "**[improve]** Daytime stress redraw only when levels change (#195).",
                "**[improve]** Theme apply toast Â· Fitness Age ignore until calibrated (#238/#230).",
                "**[improve]** Custom alarm rename blank/duplicate guards (#129).",
                "**[improve]** Lab Book under Health only Â· Pair CTA hides mid-scan (#192/#277).",
                "**[improve]** HC exact permission names Â· import lag progress Â· denialâ†’Settings (#194/#210/#232/#264).",
                "**[improve]** Battery opt after 1 drop Â· sync helper never silent (#268/#259).",
                "**[improve]** Help links Â· charging preview path Â· large-text icons-only tabs (#250/#258/#248).",
                "**[improve]** Calories honesty Â· Sport ML cue Â· Cycle orphan tip Â· card radius (#270/#271/#163/#243/#239).",
                "**[improve]** WHOOP vs open-BLE honesty earlier Â· mid-set sport timing (#269/#263/#143/#156).",
                "**[chore]** Compile Guardian one gate + publish 8.6.148/418.",
            ),
        ),
        Release(
            version = "8.6.147",
            title = "400 grind Â· Cycle icon Â· Alarm suggest Â· Connections Â· HC honesty",
            date = "July 2026",
            items = listOf(
                "**[improve]** Cycle tab icon WaterDrop (less clinical) Â· forecast vs logged legend (#215/#217).",
                "**[improve]** Cycle opt-in explains why predictions exist (#227).",
                "**[improve]** Alarm Suggest wake from sleep mid Â· Â±15 window bound toast (#94/#130).",
                "**[improve]** Backup blurb mentions Stress series Â· Connections lists Bluetooth (#189/#191).",
                "**[improve]** Theme pack preview swatch Â· dual-app tip in About (#223/#224).",
                "**[improve]** HC permission sheet cue Â· Stress WHOOP labels honest empty (#179/#211).",
                "**[improve]** Low battery overnight charge reminder Â· Compare blue = WHOOP app (#265/#273).",
                "**[chore]** Compile Guardian one gate + publish 8.6.147/417.",
            ),
        ),
        Release(
            version = "8.6.146",
            title = "400 grind bank Â· Stress honesty Â· Cycle lengths Â· Effort int Â· Live zones",
            date = "July 2026",
            items = listOf(
                "**[improve]** HR zones show Profile max-HR source (#160).",
                "**[improve]** Live workout polite live-region HR + mid-set sport cue (#147/#176).",
                "**[improve]** Effort 0â€“100 displays as int; durations stay m; HR int (#175).",
                "**[improve]** Stress tip vs WHOOP same-evening honesty Â· scrub motion glyph caption (#182/#187/#188).",
                "**[improve]** Past-day banked-only cue Â· Workouts â€¢â€¢â€¢ edit path (#152/#256).",
                "**[improve]** Cycle typical length steppers Â· theme pack blurb (#220/#233).",
                "**[improve]** Lab Book vs Health vs Insights jobs Â· cuff BP discoverability (#180/#212).",
                "**[improve]** Prior 145 bank leftovers already in tree (Intervals/Sleep/Cycle/Compare).",
                "**[chore]** Compile Guardian one gate + publish 8.6.146/416.",
            ),
        ),
        Release(
            version = "8.6.145",
            title = "Today IA Â· Health vitals Â· sleep catch-up Â· Strength Â· battery/connect honesty",
            date = "July 2026",
            items = listOf(
                "**[improve]** Today Key Metrics default omits HRV/RHR/Resp/SpOâ‚‚ â€” Health owns those chips; editor can re-enable.",
                "**[improve]** Compare pass score flat (no nested brick) + short purpose / empty hints.",
                "**[improve]** Today avatar â†’ Settings lands on Profile (scroll focus).",
                "**[improve]** Today Heart Rate overline: day trend Â· live HR on Health.",
                "**[improve]** DEBUG More: Test Centre only for charging preview (no duplicate UI-demo card).",
                "**[improve]** Vessel underCaptions: fills up Â· Rest = night readiness/Sleep Â· Effort = WHOOP Strain.",
                "**[improve]** Sessions overline These add to Effort Â· Stress compare â†’ Health.",
                "**[improve]** Hold + dial includes Strength Â· grip-pulse default OFF.",
                "**[improve]** Overnight sleep catch-up honesty Â· charging overlay no re-pop on BLE flap.",
                "**[improve]** Battery ETA by MG/5 vs 4 Â· connect never mislabels MG as WHOOP 4.",
                "**[improve]** Strength Trainer upgrades + UTF-8 glyph cleanup (no mojibake).",
                "**[improve]** Scrutiny IA: empty-score notes Â· slim alarm footnote Â· 6-axis Advanced Â· Sleep today/yesterday.",
                "**[improve]** Live banked-only vitals Â· Health rose strip / Charge contributors.",
                "**[improve]** Outlined bottom-nav icon weight Â· More active only on More (#13/#141).",
                "**[improve]** Hold-+ spokes fade in 120ms after arm Â· Live HR primary in + sheet (#120/#140).",
                "**[improve]** Alarm Armed OLED breathe Â· hold-accelerate window stepper (#118/#89/#102).",
                "**[improve]** Past-day Compare WHOOP honesty Â· Rescored HC toast (#41/#38).",
                "**[improve]** Sleep Import CTA auto-launches WHOOP export picker (#72).",
                "**[improve]** Sleep Tools Nap opens manual nap picker (#61).",
                "**[improve]** Trends / Sleep chart tap deep-links wake-day (#63).",
                "**[improve]** Cycle log teachable order Â· forecast Â±4 Â· PhaseÂ·training Â· reminders taxonomy.",
                "**[improve]** More overflow shows via More breadcrumb (#14).",
                "**[improve]** Alarm sound/vibe link near Arm Â· custom preset TalkBack (#104/#117).",
                "**[add]** SessionUiFlags.autoLaunchWhoopImport one-shot.",
                "**[add]** SessionUiFlags.settingsFocusProfile one-shot.",
                "**[add]** KeyMetric.healthOwnedOptional Â· TODAY_HR_TREND_OVERLINE lacquer.",
                "**[add]** ScreenScaffold optional scrollState for Settings Profile focus.",
                "**[fix]** keyMetrics_defaultOmitsHealthOwnedVitals.",
                "**[improve]** Intervals lacquer calm Â· Sleep Soft-wake chime preview Â· wind-down dim sky (#64/#93/#96/#121).",
                "**[improve]** Live title (not Live Body Console) Â· Health teaching empty Â· Cycle empty Log today (#161/#201/#222/#228).",
                "**[improve]** Cycle privacy + phase under title Â· Estimate only Â· soft Saved (#218/#221/#237/#249/#253).",
                "**[improve]** Sport IMU disclosure Â· suggested-first Â· quiet conf Â· Breatheâ†’Stress (#145/#148/#171/#172/#173).",
                "**[chore]** Compile Guardian gate before publish Â· catalog PR via publish-catalog-pr.",
            ),
        ),
        Release(
            version = "8.6.133",
            title = "Alarm rename/remove Â· strap gen Â· HrvSnapshot/R-R Â· 10imp+25add",
            date = "July 2026",
            items = listOf(
                // --- improve (10) ---
                "**[improve]** Rename dialog Label/Save/Cancel â†’ ALARM_RENAME_FIELD/SAVE/CANCEL DRY.",
                "**[improve]** Remove confirm Keep â†’ ALARM_KEEP_LABEL DRY.",
                "**[improve]** Strap buzz/OEM generation name â†’ alarmStrapGenerationName DRY.",
                "**[improve]** HrvSnapshot title/subtitle â†’ HRV_READING_TITLE/SUBTITLE DRY.",
                "**[improve]** HrvSnapshot phase pills Ready/Capturing/Done â†’ HRV_PHASE_* DRY.",
                "**[improve]** HrvSnapshot strap live/off + Close a11y â†’ HRV_STRAP_*/CLOSE DRY.",
                "**[improve]** HrvSnapshot dial MSÂ·RMSSD + capturing sub/a11y â†’ hrvMsRmssdUnit/CapturingSub/DialA11y.",
                "**[improve]** HrvSnapshot primary Cancel/Take another + Save/Saved â†’ HRV_*_LABEL DRY.",
                "**[improve]** HrvSnapshot result overline/tiles/insufficient beats â†’ HRV_YOUR/SDNN/MEAN/BEATS + hrvInsufficientBeatsBody.",
                "**[improve]** HrvSnapshot instruction copy â†’ hrvInstruction DRY.",
                // --- add (25) ---
                "**[add]** ALARM_RENAME_FIELD_LABEL lacquer constant.",
                "**[add]** ALARM_SAVE_LABEL lacquer constant.",
                "**[add]** ALARM_CANCEL_LABEL lacquer constant.",
                "**[add]** ALARM_KEEP_LABEL lacquer constant.",
                "**[add]** STRAP_WHOOP_5_MG lacquer constant.",
                "**[add]** STRAP_WHOOP_4 lacquer constant.",
                "**[add]** HRV_READING_TITLE lacquer constant.",
                "**[add]** HRV_READING_SUBTITLE lacquer constant.",
                "**[add]** HRV_PHASE_READY lacquer constant.",
                "**[add]** HRV_PHASE_CAPTURING lacquer constant.",
                "**[add]** HRV_PHASE_DONE lacquer constant.",
                "**[add]** HRV_STRAP_LIVE lacquer constant.",
                "**[add]** HRV_STRAP_OFF lacquer constant.",
                "**[add]** HRV_CLOSE_A11Y lacquer constant.",
                "**[add]** HRV_MS_UNIT lacquer constant.",
                "**[add]** HRV_SAVE_LABEL lacquer constant.",
                "**[add]** HRV_SAVED_LABEL lacquer constant.",
                "**[add]** HRV_CANCEL_LABEL lacquer constant.",
                "**[add]** HRV_TAKE_ANOTHER_LABEL lacquer constant.",
                "**[add]** HRV_YOUR_READING_OVERLINE lacquer constant.",
                "**[add]** HRV_SDNN_LABEL Â· HRV_MEAN_HR_LABEL Â· HRV_BEATS_LABEL.",
                "**[add]** HRV_MS_CAPTION Â· HRV_BPM_CAPTION Â· HRV_USED_CAPTION.",
                "**[add]** alarmStrapGenerationName helper.",
                "**[add]** hrvMsRmssdUnit Â· hrvCapturingSub Â· hrvDialCapturingA11y helpers.",
                "**[add]** hrvPrimaryLabel Â· hrvInstruction Â· hrvInsufficientBeatsBody Â· AppChangelog 8.6.133 MAIN publish.",
            ),
        ),
        Release(
            version = "8.6.132",
            title = "Sleep/Alarm steppers Â· strap/custom DRY Â· type-40/RR Â· 25imp+10add",
            date = "July 2026",
            items = listOf(
                // --- improve (25) ---
                "**[improve]** Turn-back Less sensitive stepper â†’ ALARM_LESS_SENSITIVE_A11Y.",
                "**[improve]** Turn-back More sensitive stepper â†’ ALARM_MORE_SENSITIVE_A11Y.",
                "**[improve]** Wake-rested Lower Charge threshold â†’ ALARM_LOWER_THRESHOLD_A11Y.",
                "**[improve]** Wake-rested Higher Charge threshold â†’ ALARM_HIGHER_THRESHOLD_A11Y.",
                "**[improve]** Wake-rested Lower sleep-need % â†’ ALARM_LOWER_PERCENT_A11Y.",
                "**[improve]** Wake-rested Higher sleep-need % â†’ ALARM_HIGHER_PERCENT_A11Y.",
                "**[improve]** Soft-window Shorten â†’ ALARM_SHORTEN_WINDOW_A11Y.",
                "**[improve]** Soft-window Lengthen â†’ ALARM_LENGTHEN_WINDOW_A11Y.",
                "**[improve]** Custom alarms title â†’ alarmCustomAlarmsTitle DRY.",
                "**[improve]** Custom alarms help â†’ alarmCustomAlarmsHelp DRY.",
                "**[improve]** Custom exact-off warn â†’ alarmCustomExactOffCaption DRY.",
                "**[improve]** Custom empty body â†’ alarmCustomEmptyCaption DRY.",
                "**[improve]** Custom limit foot â†’ alarmCustomLimitCaption DRY.",
                "**[improve]** New custom default label â†’ alarmDefaultCustomLabel DRY.",
                "**[improve]** Custom Remove link â†’ ALARM_REMOVE_LABEL.",
                "**[improve]** Remove confirm title â†’ alarmRemoveConfirmTitle DRY.",
                "**[improve]** Remove confirm body â†’ alarmRemoveConfirmBody DRY.",
                "**[improve]** Strap firmware toggle â†’ ALARM_STRAP_FIRMWARE_LABEL.",
                "**[improve]** Strap firmware help â†’ alarmStrapFirmwareHelp DRY.",
                "**[improve]** Strap firmware off tip â†’ alarmStrapFirmwareOffTip DRY.",
                "**[improve]** Strap wake TimeChip a11y â†’ alarmStrapWakeTimeA11y.",
                "**[improve]** Strap armed honesty â†’ alarmStrapArmedCaption DRY.",
                "**[improve]** How smart wake body â†’ alarmHowSmartWakeBody DRY.",
                "**[improve]** Sleep wake-up TimeChip a11y â†’ alarmWakeUpTimeA11y.",
                "**[improve]** Hrv how-measured/methodology/needs-R-R + Live R-R-locked trust/mode DRY.",
                // --- add (10) ---
                "**[add]** ALARM_LESS/MORE_SENSITIVE_A11Y lacquer constants.",
                "**[add]** ALARM_LOWER/HIGHER_THRESHOLD_A11Y lacquer constants.",
                "**[add]** ALARM_LOWER/HIGHER_PERCENT_A11Y lacquer constants.",
                "**[add]** ALARM_SHORTEN/LENGTHEN_WINDOW_A11Y lacquer constants.",
                "**[add]** ALARM_STRAP_FIRMWARE_LABEL Â· ALARM_REMOVE_LABEL.",
                "**[add]** alarmCustomAlarmsTitle/Help/ExactOff/Empty/Limit/DefaultLabel helpers.",
                "**[add]** alarmRemoveConfirmTitle/Body Â· alarmStrapFirmwareHelp/OffTip/WakeTime/Armed.",
                "**[add]** alarmHowSmartWakeBody Â· alarmWakeUpTimeA11y.",
                "**[add]** hrvHowMeasured/methodology/needsRrStream Â· liveRrLockedTrust/Mode.",
                "**[add]** AppChangelog 8.6.132 Whatâ€™s New (25imp+10add) Â· MAIN store publish.",
            ),
        ),
        Release(
            version = "8.6.124",
            title = "LifeMotes chapter cohesion Â· Cycle/Sip/Fuel Â· 25imp+10add",
            date = "July 2026",
            items = listOf(
                // --- improve (25) ---
                "**[improve]** Today sip corner â†’ LifeChapterLacquer.CORNER_DP (was hard 16).",
                "**[improve]** Today sip / Fuel / Cycle min height â†’ CHAPTER_MIN_HEIGHT_DP.",
                "**[improve]** Today + Nutrition sip a11y â†’ hydrationSipA11y (litres DRY).",
                "**[improve]** Today + Nutrition goal-met footnote â†’ hydrationGoalMetCaption.",
                "**[improve]** Today / Nutrition sipÂ·mealÂ·supp burst â†’ SIP_BURST_MS.",
                "**[improve]** Today Fuel peek line â†’ fuelPeekLine DRY.",
                "**[improve]** Today Fuel peek a11y includes macros when logged.",
                "**[improve]** Cycle Open haptic (Fuel peek TextHandleMove parity).",
                "**[improve]** Cycle soft +fuel / easy bit â†’ cycleSoftBitCaption.",
                "**[improve]** Cycle card a11y â†’ cycleCardA11y (phase Â· soft Â· Open).",
                "**[improve]** CycleStarLifeMotes intensity â†’ CYCLE_INTENSITY lacquer.",
                "**[improve]** CycleStarLifeMotes a11y Learning vs known phase.",
                "**[improve]** Nutrition sip a11y litres (was ml) â€” Today parity.",
                "**[improve]** Nutrition meals hero pad â†’ PAD_V_DP (was 12).",
                "**[improve]** Nutrition meals overline TODAY â†’ FUEL (Today chapter).",
                "**[improve]** Nutrition meals intensity â†’ FUEL_HERO_INTENSITY.",
                "**[improve]** Nutrition meals hero a11y â†’ fuelPeekA11y.",
                "**[improve]** Quick meal chip wash â†’ FUEL_CHIP_INTENSITY.",
                "**[improve]** NutritionMealLifeMotes default â†’ FUEL_HERO_INTENSITY.",
                "**[improve]** Creatine reminder â†’ LifeChapterLacquer surface/border/pad.",
                "**[improve]** Creatine reminder a11y Taken / not logged.",
                "**[improve]** HydrationSipLifeMotes a11y Sip droplets.",
                "**[improve]** HydrationGoalBloom a11y when goal met.",
                "**[improve]** NutritionMealLifeMotes a11y Fuel meal motes.",
                "**[improve]** No invented SpOâ‚‚/BP Â· no sleep staging math this ship.",
                // --- add (10) ---
                "**[add]** CYCLE_INTENSITY Â· FUEL_HERO_INTENSITY Â· FUEL_CHIP_INTENSITY lacquer.",
                "**[add]** CHAPTER_MIN_HEIGHT_DP Â· SUPP_SURFACE_ALPHA Â· SIP_BURST_MS.",
                "**[add]** hydrationSipA11y + hydrationGoalMetCaption helpers.",
                "**[add]** fuelPeekLine + fuelPeekA11y shared Fuel copy.",
                "**[add]** cycleSoftBitCaption + cycleCardA11y helpers.",
                "**[add]** CycleStarLifeMotes intensity parameter.",
                "**[add]** Nutrition empty Fuel line via fuelPeekLine cohesion.",
                "**[add]** docs/TODAY_LIFE_ANIM Cycle/Sip/Fuel cohesion notes.",
                "**[add]** FABLE archive batch for 8.6.124 LifeMotes ship.",
                "**[add]** AppChangelog 8.6.124 Whatâ€™s New (25imp+10add).",
            ),
        ),
        Release(
            version = "8.6.123",
            title = "type-40/RR DRY Â· Alarm aim craft Â· 25imp+10add",
            date = "July 2026",
            items = listOf(
                // --- improve (25) ---
                "**[improve]** Live drop dual R-R feel hairline under physiology.",
                "**[improve]** RRStrip ownOpticalCaption=false â€” no double optical caption.",
                "**[improve]** Health/Today optical lead â†’ OPTICAL_LOCK_LEAD DRY.",
                "**[improve]** rrFeelClimbCaption shared on Health/Today/RRStrip/Trust.",
                "**[improve]** Today Quick Alarm border â†’ LifeChapterLacquer.BORDER_ALPHA.",
                "**[improve]** Today/Alarm status pill wash â†’ STATUS_PILL_WASH.",
                "**[improve]** WindowCard status â†’ bordered pill + settle + a11y.",
                "**[improve]** WindowCard deadline cue + Effort when may-drift.",
                "**[improve]** Alarm glance Bedtime icon (Today Quick parity).",
                "**[improve]** Alarm glance frost-only (no opaque 0.90 slab).",
                "**[improve]** Alarm glance bridge caption â†’ BRIDGE_CAPTION_ALPHA.",
                "**[improve]** Live datastream â†’ type40SessionCaption honesty.",
                "**[improve]** Live datastream R-R shows lock% during optical wait.",
                "**[improve]** Live Proof R-R shows lock% during optical wait.",
                "**[improve]** Today empty-chips optical path â†’ OpticalLockHairline.",
                "**[improve]** signalTrust / connectionModeDetail include lock%.",
                "**[improve]** Signal Trust R-R cyan while locking (not ash Missing).",
                "**[improve]** RRStrip climb caption shares rrFeelClimbCaption.",
                "**[improve]** Alarm page scaffold subtitle â†’ alarmWakeLiveSubtitle.",
                "**[improve]** Alarm glance aim line â†’ alarmGlanceAimCaption.",
                "**[improve]** Today Quick aim line â†’ alarmGlanceAimCaption.",
                "**[improve]** Today Quick status pill a11y contentDescription.",
                "**[improve]** WindowCard moons â†’ ALARM_WINDOW_MOON_INTENSITY.",
                "**[improve]** WindowCard aim/deadline/backup â†’ lacquer alphas.",
                "**[improve]** WindowCard exact-off opens Settings (glance parity).",
                // --- add (10) ---
                "**[add]** STATUS_PILL_WASH lacquer constant.",
                "**[add]** BRIDGE_CAPTION_ALPHA lacquer constant.",
                "**[add]** OPTICAL_LOCK_LEAD shared lead string.",
                "**[add]** rrFeelClimbCaption helper.",
                "**[add]** type40SessionCaption helper.",
                "**[add]** RRStrip.ownOpticalCaption parameter.",
                "**[add]** alarmGlanceAimCaption â€” Today + Alarm aim DRY.",
                "**[add]** ALARM_WINDOW_MOON_INTENSITY lacquer constant.",
                "**[add]** docs/TODAY_LIFE_ANIM bank notes for optical/Alarm craft.",
                "**[add]** AppChangelog 8.6.123 Whatâ€™s New (25imp+10add).",
            ),
        ),
        Release(
            version = "8.6.122",
            title = "Alarm status DRY Â· Window moons Â· optical/feel Â· 10imp+25add",
            date = "July 2026",
            items = listOf(
                // --- improve (10) ---
                "**[improve]** Alarm glance Matches Alarm (was Rest plan) under clock.",
                "**[improve]** Health optical caption type-40 wording honesty.",
                "**[improve]** Signal Trust R-R detail withRr + N-of-3 feel.",
                "**[improve]** RRStrip 2-beat needâ‰¥3 honesty.",
                "**[improve]** Today Matches Alarm caption â†’ Rest tint (Alarm parity).",
                "**[improve]** Today/Alarm status pill border â†’ STATUS_PILL_BORDER.",
                "**[improve]** Alarm Arm/Extras frost â†’ ALARM_ARM_WASH / ALARM_EXTRAS_WASH.",
                "**[improve]** AlarmSettingsCard + OEM tip â†’ LifeChapterLacquer.",
                "**[improve]** Today exact-off caption opens Settings (Alarm parity).",
                "**[improve]** No invented SpOâ‚‚/BP Â· no sleep staging math this ship.",
                // --- add (25) ---
                "**[add]** opticalLockCaption shared â€” type-40 Â· with R-R Â· lock%.",
                "**[add]** RrFeelProgressHairline while beats climb toward feel RMSSD.",
                "**[add]** RR_FEEL lacquer track/fill/need constants.",
                "**[add]** OpticalLockHairline a11y â€” Optical lock N percent.",
                "**[add]** RRStrip type40WithRr + feel hairline wiring.",
                "**[add]** Live/Health/Today with-R-R optical captions.",
                "**[add]** Health/Today feel-progress cue under R-R climb.",
                "**[add]** Live R-R proof mean of recent intervals.",
                "**[add]** Alarm fifth moon crescent densify.",
                "**[add]** Alarm glance exact-off may-drift (Today parity).",
                "**[add]** alarmArmStatusLabel / alarmArmStatusColor shared helpers.",
                "**[add]** alarmBedtimeFootCaption â€” Matches / Moon quiet / Exact-off.",
                "**[add]** alarmWakeLiveSubtitle + alarmDeadlineCue.",
                "**[add]** ALARM_ARM_WASH Â· ALARM_EXTRAS_WASH Â· ALARM_WINDOW_WASH.",
                "**[add]** STATUS_PILL_BORDER Â· ARMED_CAPTION_ALPHA Â· ARM_SETTLE_MS.",
                "**[add]** AlarmBedMoonLifeMotes a11y Armed / Off Â· Moon quiet.",
                "**[add]** Wake WindowCard frost + quieter moons + status pill.",
                "**[add]** WindowCard Off â†’ Moon quiet Â· Arm for a bedtime plan.",
                "**[add]** docs/TODAY_LIFE_ANIM Alarm status DRY + wash notes.",
                "**[add]** FABLE archive batch for 8.6.122 Alarm DRY ship.",
                "**[add]** Cadence rotate â€” next ship 25 improve + 10 add.",
                "**[add]** AppChangelog 8.6.122 Whatâ€™s New (10imp+25add).",
                "**[add]** ANY_MODEL_CONTINUE bank cleared after 8.6.122 publish.",
                "**[add]** Publish MAIN 8.6.122-fable store listing.",
                "**[add]** Glance/Arm corners wired to LifeChapterLacquer.CORNER_DP.",
            ),
        ),
        Release(
            version = "8.6.121",
            title = "Optical lock Â· ArmedÂ·Rest Â· lacquer Â· 25imp+10add",
            date = "July 2026",
            items = listOf(
                // --- improve (25) ---
                "**[improve]** Live physiology shows LOCK% while type-40 optical R-R climbs.",
                "**[improve]** Live OpticalLockHairline under physiology during lock wait.",
                "**[improve]** RRStrip caption names lock% + type-40 while awaiting intervals.",
                "**[improve]** RRStrip feel caption includes beat count with feel RMSSD.",
                "**[improve]** RRStrip single-interval honesty â€” need â‰¥3 for feel RMSSD.",
                "**[improve]** Signal Trust R-R tile shows lock% / Lockingâ€¦ (not blank Missing).",
                "**[improve]** Signal Trust R-R detail â€” optical lock Â· N type-40 / need â‰¥3.",
                "**[improve]** signalTrustSummary â€” optical lock honesty on encrypted + HR-only.",
                "**[improve]** connectionModeDetail â€” R-R locked vs optical lockâ€¦ copy.",
                "**[improve]** Health footer LOCK label + % while awaiting type-40 R-R.",
                "**[improve]** Health State pill reads LOCKâ€¦ during optical wait.",
                "**[improve]** Health OpticalLockHairline under live HR footer.",
                "**[improve]** Today Health OpticalLockHairline under optical-lock caption.",
                "**[improve]** Today Quick Alarm Armed Â· may drift when exact alarm off.",
                "**[improve]** Today Quick Alarm may-drift pill uses Effort tint (Alarm parity).",
                "**[improve]** Today Quick Alarm exact-off caption under clock.",
                "**[improve]** Today Quick Alarm frost wash â†’ LifeChapterLacquer.TODAY_ALARM_WASH.",
                "**[improve]** Alarm glance frost wash â†’ LifeChapterLacquer.ALARM_GLANCE_WASH.",
                "**[improve]** Wake settings subtitle Armed Â· Rest Â· wake windowâ€¦ cohesion.",
                "**[improve]** Wake settings Off subtitle â€” Rest bedtime plan quiet.",
                "**[improve]** PersonalSleepPlanCard lacquer via LifeChapterLacquer.",
                "**[improve]** ExplanationCard lacquer via LifeChapterLacquer.",
                "**[improve]** HydrationSipLifeMotes intensity + fifth quiet drip.",
                "**[improve]** CycleStarLifeMotes fifth quiet star (denser Cycle life).",
                "**[improve]** No invented SpOâ‚‚/BP Â· no sleep staging math this ship.",
                // --- add (10) ---
                "**[add]** OpticalLockHairline â€” shared cyan lock progress (token alpha).",
                "**[add]** LifeChapterLacquer SIP/wash/optical-lock constants.",
                "**[add]** RRStrip lockPct + type40Frames params for lock captions.",
                "**[add]** HeartRateFooter hrvLabel â€” LOCK vs RMSSD during optical wait.",
                "**[add]** docs/TODAY_LIFE_ANIM.md optical-lock + lacquer wash notes.",
                "**[add]** FABLE archive batch for 8.6.121 optical-lock ship.",
                "**[add]** Cadence rotate â€” next ship 10 improve + 25 add.",
                "**[add]** AppChangelog 8.6.121 Whatâ€™s New (25imp+10add).",
                "**[add]** ANY_MODEL_CONTINUE bank cleared after 8.6.121 publish.",
                "**[add]** Publish MAIN 8.6.121-fable store listing.",
            ),
        ),
        Release(
            version = "8.6.120",
            title = "Life anim Â· Fuel/Sip/Alarm cohesion Â· 10imp+25add",
            date = "July 2026",
            items = listOf(
                // --- improve (10) ---
                "**[improve]** Today Quick Alarm moons quieter (intensity 0.82) vs Alarm glance (1.0).",
                "**[improve]** Alarm Armed status tint â†’ Rest (not wakeAccent) for chapter cohesion.",
                "**[improve]** HydrationSipBurstSpark â€” CTA-side flash + satellite sparks (anti-glow).",
                "**[improve]** NutritionMealLifeMotes â€” fifth quiet diamond for denser Fuel life.",
                "**[improve]** AlarmBedMoonLifeMotes â€” fourth crescent + intensity param.",
                "**[improve]** Today/Nutrition sip + Fuel + Cycle lacquer via LifeChapterLacquer constants.",
                "**[improve]** Sleep light-only honesty â€” generic asleep, not â€œon-device found no Deep/REMâ€.",
                "**[improve]** Today Health optical-lock caption when live HR awaits type-40 R-R.",
                "**[improve]** Health HR footer label RMSSD (live feel when type-40 locks).",
                "**[improve]** No invented SpOâ‚‚/BP Â· no sleep staging math this ship.",
                // --- add (25) ---
                "**[add]** LifeChapterLacquer â€” shared surface/corner/pad/intensity contract.",
                "**[add]** HydrationGoalBloom â€” soft cyan bloom when sip goal met.",
                "**[add]** NutritionMealBurstSpark â€” Charge diamond flash on meal log.",
                "**[add]** SupplementLogBurstSpark â€” Rest spark on catalog / custom log.",
                "**[add]** Nutrition Sip +250 ml inline (Today parity) + burst spark.",
                "**[add]** Nutrition hydration Goal met caption when tube is full.",
                "**[add]** Today sip Goal met caption + goal bloom.",
                "**[add]** Today Fuel peek carbs/fat grams when macros logged.",
                "**[add]** Today Fuel Open haptic (TextHandleMove).",
                "**[add]** Alarm glance Matches Alarm Â· soonest / Moon quiet captions (Today sync).",
                "**[add]** Quick meal chips Charge mote wash under chip row.",
                "**[add]** Meal burst spark on Nutrition hero after quick/custom log.",
                "**[add]** Supplement burst spark near creatine reminder on catalog log.",
                "**[add]** HrvAnalyzer.feelRmssdMs â€” membership-free live R-R feel.",
                "**[add]** Today Health Live RMSSD chip from type-40 R-R bank.",
                "**[add]** Live type-40 row shows live RMSSD ms (no membership).",
                "**[add]** Health optical-lock caption while awaiting type-40 R-R.",
                "**[add]** Alarm moon intensity API for Today vs Glance cohesion.",
                "**[add]** Cycle card lacquer wired to LifeChapterLacquer.",
                "**[add]** Nutrition More tertiary door beside Sip (Today More parity).",
                "**[add]** docs/TODAY_LIFE_ANIM.md â€” burst/bloom/intensity contract for 8.6.120.",
                "**[add]** FABLE archive batch for 8.6.120 life-anim ship.",
                "**[add]** Cadence rotate â€” next ship 25 improve + 10 add.",
                "**[add]** AppChangelog 8.6.120 Whatâ€™s New (10imp+25add).",
                "**[add]** Publish MAIN 8.6.120-fable store listing.",
            ),
        ),
        Release(
            version = "8.6.119",
            title = "Wed stages Â· live Charge Â· Sleep/Alarm frost Â· ~50 notes",
            date = "July 2026",
            items = listOf(
                "**[fix]** Wednesday HC awake-only nights now fill Stage breakdown + NOOP Asleep (tibâˆ’awake â†’ light).",
                "**[fix]** SleepStageTotals / parseSessionStages read `{stage,min}` HC arrays (not only timed `-noop`).",
                "**[fix]** SLEEPING / asleep / core map to light so phone stages arenâ€™t dropped.",
                "**[fix]** enrichAwakeOnlyStages writes timed start/end segments so the hypnogram always has intervals.",
                "**[fix]** selectNight synthesizes hypnogram segments when stagesJSON lacks timed epochs.",
                "**[fix]** sumGroupStages uses hero fill â€” awake-only JSON no longer zeros the chart.",
                "**[fix]** Pre-onset stub detector ignores HC awake-only mains (tibâˆ’awake counts as sleep).",
                "**[fix]** Restage-fail path still banks enriched `-noop` nights (sparse gravity / offline).",
                "**[fix]** Sleep browse prefers local wake-day; snaps off stale yesterday when todayâ€™s night banks.",
                "**[fix]** ensureHealthConnectSleepFresh before Sleep â—€/â–¶ so morning HC wakes appear.",
                "**[fix]** ensureStrapSleepBanked syncs + rescores when bonded HR lags (>3h).",
                "**[improve]** NoopSleep browse log includes heroAsleep + heroTimed for ADB proof.",
                "**[improve]** HC gap-fill replaces weak strap stubs (<3h) when phone night is clearly longer.",
                "**[add]** SleepHeroStagesTest â€” awake-only fill, enrich timed segments, selectNight synth.",
                "**[fix]** Charge refreshes when sleep lands â€” sleep fingerprint forces analyzeRecent.",
                "**[fix]** backfillRecoveryWithSleep keeps Charge live with Rest alongside Effort backfill.",
                "**[fix]** HC import clears sleep watermark + rescored Charge/Rest immediately.",
                "**[improve]** Recovery uses Rest composite as sleepPerf (PRODUCT) â€” no invented vitals.",
                "**[improve]** sleep_performance series upserts in lockstep when Charge backfill runs.",
                "**[add]** sleepFingerprint + sleepAnalyzeWatermark prefs (count:maxEndTs).",
                "**[improve]** Today Quick Alarm â€” frosted Rest glass (sky reads through), not opaque slab.",
                "**[improve]** Alarm glance frost washStrength 1.05 â€” stronger glass edge on sky.",
                "**[improve]** Today bedtime glance readable primary ink on Rest lacquer.",
                "**[improve]** Alarm Off moon quiet + Armed Matches Alarm captions retained.",
                "**[improve]** Sleep/Alarm lit tabs + swipe retained; frost on Glance card.",
                "**[improve]** Full-bleed sky + scaffold softFade retained on Sleep shell.",
                "**[improve]** Bedtime / Alarm contrast + floating moon motes.",
                "**[improve]** Health HR hero + resolvedSelectedDayKey stale reject retained.",
                "**[improve]** Offline strap sleep path when HC empty/stale.",
                "**[improve]** HC fuse asleep minutes for Rest when stages awake-only.",
                "**[improve]** Logical-day ticker + Effort same-day floor retained.",
                "**[improve]** Bottom nav underline-only selection retained.",
                "**[improve]** Key Metrics equal tiles + Health one-row strip retained.",
                "**[improve]** LifeMotes sip/moon/meal/Cycle polish from 8.6.117 bank.",
                "**[improve]** Today Rest/Cycle/Fuel/Sip lacquer cohesion retained.",
                "**[improve]** Nutrition Fuel peek + sip burst retained.",
                "**[improve]** Cycle Learning dimmed stars retained.",
                "**[improve]** WindowStepper / Armed Rest caption rhythm retained.",
                "**[add]** Timed-segment enrich for every HC-only browse merge path.",
                "**[add]** Charge backfill log line when days refresh.",
                "**[add]** Sleep FP gate beside HR FP in 15-min analyze loop.",
                "**[add]** HC sleepingâ†’light in HcNoopAlign.stagesFromJson.",
                "**[add]** Synthetic timeline segments helper (internal, unit-tested path).",
                "**[add]** Restage-fail `-noop` bank for promoteWindow nights.",
                "**[add]** heroDisplay session fallback for stage-less DailyMetric nights.",
                "**[add]** Efficiency-from-TIB when stored SE missing on HC nights.",
                "**[add]** Docs/CONTINUE ship note for 8.6.119 stages+Charge.",
                "**[add]** FABLE archive batch for Wed stages + live Charge.",
                "**[add]** Cadence rotate â€” next bank 10 improve + 25 add.",
                "**[improve]** No invented Deep/REM â€” light = generic asleep only when unstaged.",
                "**[improve]** Stage legend / HypnogramWithAxis still drive Stage breakdown card.",
                "**[improve]** Publish MAIN 8.6.119-fable / 389 to GitHub Releases.",
            ),
        ),
        Release(
            version = "8.6.118",
            title = "Interim store bump (superseded by 8.6.119)",
            date = "July 2026",
            items = listOf(
                "**[improve]** Version bump â€” Wed stages + live Charge land in 8.6.119.",
            ),
        ),
        Release(
            version = "8.6.117",
            title = "Life anim polish Â· Today/Alarm craft Â· 25imp+10add",
            date = "July 2026",
            items = listOf(
                // --- improve (25) ---
                "**[improve]** HydrationSipLifeMotes â€” softer bob, cyan wash, fourth drip, alpha â‰¤0.22.",
                "**[improve]** AlarmBedMoonLifeMotes â€” gentle sway + slower drift; Off quieter bloom.",
                "**[improve]** NutritionMealLifeMotes â€” quieter rise + intensity for Fuel peek.",
                "**[improve]** Cycle stars â€” longer hover / softer break; Learning phase dimmed.",
                "**[improve]** Today Rest/Cycle/Fuel/Sip lacquer unified (0.50 / 16dp / 11dp pad).",
                "**[improve]** Today Fuel + sip subheads SemiBold; sip More demoted tertiary.",
                "**[improve]** Today Quick Alarm bed clock 22sp + no outer REST overline.",
                "**[improve]** Today Armed caption â†’ Matches Alarm Â· {soonest}; Off moon quiet synced.",
                "**[improve]** Nutrition hydration + meals hero match Today sip/Fuel lacquer.",
                "**[improve]** Nutrition â†’ Today door shortened to Fuel Â· bedtime on Today.",
                "**[improve]** Alarm glance Rest lacquer + 16dp; RECOMMENDED BEDTIME Rest overline.",
                "**[improve]** Alarm glance hero rectangle â€” 20sp clock, compact BEDTIMEÂ·status row.",
                "**[improve]** Alarm Arm/Extras lacquer 0.50 Rest chapter (past first card).",
                "**[improve]** WindowStepper 12/14 rhythm + Armed Rest caption shortened (#25/#26).",
                "**[improve]** Bottom nav selected = icon + label + thin underline only (no tab wash).",
                "**[improve]** Active nav label accent-tints with the underline (no full crescent recolor).",
                "**[improve]** Today Health strip â€” heart + HEALTH + bpm one row (no white duplicate).",
                "**[improve]** Key Metrics equal-height tappable tiles (min 96dp + fixed caption).",
                "**[improve]** Rest under-vessel Last night chrome removed (carry dim stays honest).",
                "**[improve]** Logical-day ticker advances browse + Today on quiet overnight rollover.",
                "**[improve]** Effort same-day floor â€” no prior-day score stuck into a new wake day.",
                "**[improve]** Charge/Sleep browse advances with logicalDayKey.",
                "**[improve]** SupplementTakenLifeSpark pulse quieter + alpha-capped.",
                "**[improve]** Fold tertiary denser + Custom/Extras overlines retained (#70/#28).",
                "**[improve]** No invented SpOâ‚‚/BP Â· no sleep staging math this ship.",
                // --- add (10) ---
                "**[add]** CycleStarLifeMotes shared composable (Learning dimmed flag).",
                "**[add]** HydrationSipBurstSpark + Today Sip +250 one-shot flash.",
                "**[add]** Fuel peek protein grams when macros logged + intensity=0.72 motes.",
                "**[add]** Today Off moon quiet caption under Quick Alarm.",
                "**[add]** BarSlot selection contract â€” accent icon/label/underline only.",
                "**[add]** Alarm glance compact header Row (BEDTIME Â· status).",
                "**[add]** Logical-day ticker + Effort same-day floor helpers.",
                "**[add]** docs/TODAY_LIFE_ANIM.md polish contract for 8.6.117.",
                "**[add]** FABLE archive batch for 8.6.117 (life anim + craft).",
                "**[add]** Cadence rotate â€” next ship 10 improve + 25 add.",
            ),
        ),
        Release(
            version = "8.6.116",
            title = "Life anim Â· Today/Alarm/Nutrition cohesion Â· 10imp+25add",
            date = "July 2026",
            items = listOf(
                // --- improve (10) ---
                "**[improve]** Today Rest â†’ Fuel â†’ Sip chapter spacing (8dp) for Alarm/Nutrition cohesion.",
                "**[improve]** Nutrition hydration jump matches Today sip cyan overline + LiquidTube goal.",
                "**[improve]** Alarm Fold cover tertiary row denser gaps (#70).",
                "**[improve]** Wake settings Custom + Extras chapter overlines (#28).",
                "**[improve]** Nutrition meals hero Charge lacquer + life motes (Today vessel craft).",
                "**[improve]** Today Quick Alarm shows same bedtime plan Â· soonest as Alarm when Armed.",
                "**[improve]** Shared HydrationSipLifeMotes â€” Today sip + Nutrition jump stay in sync.",
                "**[improve]** Alarm Off gains quiet moon caption under strap honesty.",
                "**[improve]** Carried-sleep + calibrating notes get more vertical breathing room (#21).",
                "**[improve]** WindowStepper / Armed Rest caption rhythm retained on Wake settings (#25/#26).",
                // --- add (25) ---
                "**[add]** LifeMotes.kt â€” shared meal / moon / sip / supplement spark life-anim.",
                "**[add]** Nutrition meals hero life motes (Charge-token diamonds; Reduce Motion static).",
                "**[add]** Alarm bedtime moon crescents on Sleep Quick Alarm glance.",
                "**[add]** Today Quick Alarm moon crescents (active when Armed; calm when Off).",
                "**[add]** Today Fuel peek card â€” local kcal + Open â†’ Nutrition.",
                "**[add]** NutritionStore.carbsSeriesLastDays (7-day carbs spark).",
                "**[add]** NutritionStore.fatSeriesLastDays (7-day fat spark).",
                "**[add]** NutritionStore.kcalSeriesLastDays (7-day meal kcal spark).",
                "**[add]** Nutrition 7-day carbs sparkline under meals hero.",
                "**[add]** Nutrition 7-day fat sparkline under meals hero.",
                "**[add]** Nutrition week kcal total caption under kcal spark.",
                "**[add]** Meal chip haptic on Quick log.",
                "**[add]** Supplement catalog haptic on tap-to-log.",
                "**[add]** Nutrition empty meals FUEL teaching empty (honesty: no SpOâ‚‚/BP).",
                "**[add]** Nutrition â†’ Today â€œSee fuel Â· bedtime on Todayâ€ door.",
                "**[add]** Hydration goal LiquidTube on Nutrition jump.",
                "**[add]** Creatine Taken life spark when already logged today.",
                "**[add]** Dual bedtime sync caption on Today when Armed.",
                "**[add]** Alarm Off moon quiet copy when wake is Off.",
                "**[add]** HydrationSipLifeMotes shared composable.",
                "**[add]** SupplementTakenLifeSpark composable.",
                "**[add]** docs/TODAY_LIFE_ANIM.md â€” meal/moon/fuel contract.",
                "**[add]** FABLE archive batch for 8.6.116 life-anim ship.",
                "**[add]** Cadence rotate â€” next ship 25 improve + 10 add.",
                "**[add]** No invented SpO2/BP Â· no sleep staging math this ship.",
            ),
        ),
        Release(
            version = "8.6.115",
            title = "Today cohesion Â· Alarm craft Â· Nutrition sparks Â· 25imp+10add",
            date = "July 2026",
            items = listOf(
                // --- improve (25) ---
                "**[improve]** Cycle BMR/autonomic scienceCite deepened; Today Cycle card shows literature footnote.",
                "**[improve]** Fitness Age provisional caption remount-safe via ViewModel cache (no bare Awaiting flash).",
                "**[improve]** Vitality Live-estimate caption remount-safe via ViewModel cache.",
                "**[improve]** Today below-fold craft tightens toward liquid vessels (#13 cohesion).",
                "**[improve]** Compare card dual-scale craft under vessels (#15) + WHOOP/NOOP column hairline (#16).",
                "**[improve]** Empty compare â€œâ€”â€ cells match scored inset depth (#17).",
                "**[improve]** Live session overline tracking matches Alarm Rest (#19); secondary copy quieter.",
                "**[improve]** Idle Today craft after rose workout card no longer drops style (#20).",
                "**[improve]** Health strip captions unify to NoopType.caption / captionNumber (#22).",
                "**[improve]** Section titles below hero use consistent title2 + overline pairing (#29).",
                "**[improve]** Compare / Quick bed long labels maxLines + ellipsis (#30); Charge Â±N tabular (#31).",
                "**[improve]** alarmBedChromeColor â€” light â‰¥3:1 bed, no Classic purple REM, Sky Arm never ash (#39â€“41).",
                "**[improve]** Prefers-reduced-motion: no infinite breath on Today Quick chrome (#48).",
                "**[improve]** Personal sleep plan vs Alarm aim honesty when samples disagree (#42).",
                "**[improve]** Soft window vs strap-firmware desync copy when phone offline (#57).",
                "**[improve]** Test buzz vs Strap-buzz-armed brief disagreement honesty (#62).",
                "**[improve]** Wake accent vs gold theme pack â€” alarmWakeAccent on Wake settings (#96).",
                "**[improve]** WindowStepper vertical rhythm aligned with plan card (#25).",
                "**[improve]** Soft cycle Charge labeled display soft Ã—N (display capacity only; banked Charge unchanged).",
                "**[improve]** Deep / MG types 51â€“56 membership honesty Â· deepGateThresh 0.40; never invent SpOâ‚‚/BP from flag ACK.",
                "**[improve]** Nav island opacity quieter on day-cycle off (#398).",
                "**[improve]** Power-saving ease cadence (#477) â€” sync stretch when low + discharging.",
                "**[improve]** Health Monitor stress shows Live cue when strap connected (#408).",
                "**[improve]** Wear N of 4 calm-baseline footnote on Today Health + Key Metrics Stress (#432).",
                "**[improve]** Empty Health SpOâ‚‚/BP chips honest â€” Lab Book cuff for BP; never invented % (#409).",
                // --- add (10) ---
                "**[add]** Creatine daily local reminder (opt-in) on Nutrition Supplements + boot re-schedule.",
                "**[add]** Buzz the time from Alarm / Sleep surfaces (#99) with Automations speed/announce.",
                "**[add]** Home widget next-alarm line via soonestShortLabel (#98).",
                "**[add]** Nutrition weekly protein sparkline (7-day logged macros).",
                "**[add]** Hydration 7-day spark on Nutrition beside meals.",
                "**[add]** Dual buzz models copy â€” strap wake-alarm vs Buzz connected strap (#43).",
                "**[add]** Automations â†’ Wake settings door (#83) so Settings is not a third editor.",
                "**[add]** OEM phone-deadline tip on Wake settings (exact + battery savers).",
                "**[add]** Gemini bring-your-own-key on Android Coach (#400 Mac parity).",
                "**[add]** DEBUG Settings battery pill â†’ charging overlay preview (#445).",
            ),
        ),
        Release(
            version = "8.6.114",
            title = "Nutrition macros Â· dual HRV Â· sip life Â· 10imp+25add",
            date = "July 2026",
            items = listOf(
                // --- improve (10) ---
                "**[improve]** Fitness Age Key Metrics shows Early estimate caption while calibrating (never bare Awaiting).",
                "**[improve]** Vitality Key Metrics shows Live estimate caption while weekly bank builds.",
                "**[improve]** Today Hydration sip strip â€” droplet life anim + LiquidTube progress + haptic Sip.",
                "**[improve]** Alarm ExplanationCard Rest hairline lacquer (matches PersonalSleepPlan under-card).",
                "**[improve]** Nutrition meal rows show optional P/C/F macros when logged.",
                "**[improve]** Cycle take-it-easy line names soft capacity factor on the Today card.",
                "**[improve]** Wake-when-rested links Charge threshold copy to Todayâ€™s Charge vessel.",
                "**[improve]** Window stepper vertical rhythm aligned with plan card padding.",
                "**[improve]** Armed master switch gains a quiet Rest caption under Wake me up.",
                "**[improve]** Hold-+ radial motes distribute across five spokes (Sip included).",
                // --- add (25) ---
                "**[add]** Dual HRV â€” persist overnight avgSdnn (Room v18) beside RMSSD.",
                "**[add]** Key Metrics HRV tile caption SDNN N ms when banked.",
                "**[add]** Nutrition custom meal optional protein / carbs / fat fields.",
                "**[add]** Nutrition Undo last meal (haptic) on Meals.",
                "**[add]** Today one-tap Sip +250 ml when Hydration tracking is on.",
                "**[add]** Cycle soft Charge under-caption on hero (cycle-aware ~N%) when take-it-easy.",
                "**[add]** Square health tiles Fold cover pad/number density + spoken TalkBack units.",
                "**[add]** Sleep|Alarm horizontal swipe between tabs (#35).",
                "**[add]** Hold-+ fifth spoke Sip +250 ml (hydration quick log).",
                "**[add]** Nutrition day macros strip (P/C/F totals) under meals hero.",
                "**[add]** Nutrition Supplements tab badge with todayâ€™s count.",
                "**[add]** Cycle fourth quiet star mote for denser life sparkle.",
                "**[add]** Alarm Plan / Arm chapter overlines on Wake settings.",
                "**[add]** NutritionStore.dayMacros helper for daily macro totals.",
                "**[add]** Today hydration sip Reduce Motion keeps droplets static.",
                "**[add]** MealRow macro footnote when any P/C/F > 0.",
                "**[add]** Soft capacity Ã—factor copy on Cycle card when take-it-easy.",
                "**[add]** Charge vessel pointer under Wake-when-rested threshold.",
                "**[add]** Hydration sip LiquidTube on Today (goal fraction).",
                "**[add]** Docs TODAY_LIFE_ANIM + FABLE archive for 8.6.114 batch.",
                "**[add]** Cadence rotate â€” next ship 25 improve + 10 add.",
                "**[add]** Dual HRV migration test coverage (17â†’18).",
                "**[add]** AnalyticsEngine banks session-weighted avgSdnn into dailyMetric.",
                "**[add]** Sleep stager sessionAvgSdnn into overnight session model.",
                "**[add]** No invented SpO2/BP Â· no sleep staging math this ship.",
            ),
        ),
        Release(
            version = "8.6.113",
            title = "Today calm Â· date fix Â· Effort Â· four-point stars",
            date = "July 2026",
            items = listOf(
                // --- improve (25) ---
                "**[improve]** Removed Import WHOOP CTA from Home/Today â€” Pair strap only when disconnected; import stays in Data Sources.",
                "**[improve]** Dropped Rest Â· building thin caption under Today Rest vessel (Sleep still shows confidence).",
                "**[improve]** Health block moves above bedtime; chapter hairline before Alarm removed.",
                "**[improve]** Fixed date-flicker / yesterday thrash â€” Today no longer consumes Sleepâ€™s browseDayKey back into selectedDayOffset.",
                "**[improve]** DatePicker no longer re-keys on selectedDay (avoids dismiss/re-show while picking).",
                "**[improve]** Day-title scrub/rise uses short tweens instead of bouncy springs (less page flicker).",
                "**[improve]** Nav fade 180â†’140ms and softer shared-axis slide (whisper offsets) â€” less Movie Maker.",
                "**[improve]** Sleepâ†”Alarm sibling slide tightened (/28â€“/32) with Reduce Motion instant cut.",
                "**[improve]** Today Quick Alarm lower height (30sp bedtime, tighter pad) â€” still slightly taller than Cycle.",
                "**[improve]** Alarm page under-card: sleep plan + how-it-works get Rest lacquer insets.",
                "**[improve]** Nutrition more human â€” BMR sits with meals (no orphan BMR tab).",
                "**[improve]** Bottom diffusion fade more pronounced (taller softFade + stronger GlassDiffusionVeil).",
                "**[improve]** Key Metrics label Strain â†’ Effort (dual-scale honesty kept).",
                "**[improve]** Last workouts open a quick detail sheet without yanking the day to yesterday.",
                "**[improve]** Fitness Age provisional on Today Key Metrics while calibrating (â‰¥1 RHR night).",
                "**[improve]** Vitality live estimate on Today when weekly bank missing (â‰¥3 factors).",
                "**[improve]** Cycle card height trimmed so Alarm reads mid/slightly taller beside it.",
                "**[improve]** Home composition: Health â†’ bedtime â†’ Cycle reads as one cohesive chapter.",
                "**[improve]** Scores-building note no longer pushes an Import WHOOP primary when strapped.",
                "**[improve]** softFadeEdges bottom curve stronger (0.90 peak) so list melts into nav.",
                "**[improve]** GlassDiffusionVeil peak/mid alphas raised for clearer under-bar dissolve.",
                "**[improve]** NoopMotion nav tokens documented quieter in DESIGN.md motion block.",
                "**[improve]** Arm settle / Reduce Motion contract retained on slim Quick Alarm.",
                "**[improve]** TalkBack: last-workout tiles announce Open workout.",
                "**[improve]** Cadence ship: 25 improve + 10 add encoded (â‰¥35 notes).",
                // --- add (10) ---
                "**[add]** Cycle four-point stars â€” 2 short H + 2 long V triangles, Rest-token bloom.",
                "**[add]** Three stars spawn from Cycle card, hover up/around, then break/fade (~4.8s).",
                "**[add]** Cycle Reduce Motion keeps three static four-point stars (no float).",
                "**[add]** Nutrition Meals hero pairs today kcal + BMR side-by-side.",
                "**[add]** WorkoutDetailSheet reusable from Today last-workout peek.",
                "**[add]** Alarm ExplanationCard Rest lacquer surface (styled under-card).",
                "**[add]** Alarm PersonalSleepPlanCard lacquer inset under WindowCard.",
                "**[add]** docs/TODAY_LIFE_ANIM.md updated for four-point star contract.",
                "**[add]** FABLE archive batch for 8.6.113 date-flicker + Home polish.",
                "**[add]** ANY_MODEL_CONTINUE next phase = 10imp+25add after this ship.",
            ),
        ),
        Release(
            version = "8.6.112",
            title = "Today life anim Â· Cycle card Â· Nutrition Â· slim wake",
            date = "July 2026",
            items = listOf(
                "**Today Quick Alarm slimmed** â€” smaller bedtime hero (34sp), tighter padding, cuter lacquer card.",
                "**Today wake footnote removed** â€” duplicate soonest/Bed-by chrome cut; Quick Alarm carries the story.",
                "**Arm CTA** shortened to Arm / Turn off (less wake soup on Today).",
                "**Wake row** label is Wake + Settings (not â€œWake settingsâ€ essay).",
                "**Aim caption** compacted to duration Â· Â±window Â· soonest.",
                "**Rest hairline border** softer (0.22 alpha) on the Quick Alarm card.",
                "**Cycle life card on Today** when tracking is on â€” concise phase Â· day Â· Open.",
                "**Cycle sparkle-flowers** spin off card edges with subtle Rest-token bloom (not neon purple).",
                "**Cycle corner triangles** â€” 2 small + 2 big float up and break off (life anim).",
                "**Cycle Reduce Motion** freezes flowers/triangles to static calm poses.",
                "**Cycle soft labels** show Â· +fuel or Â· easy when phase modifiers apply.",
                "**Cycle physiology BMR bump** â€” luteal/peri-ovulatory modest Ã—bmrFactor on Nutrition BMR/goal.",
                "**Cycle-aware Charge soft capacity** â€” banked Charge unchanged; soft Ã—recoveryCapacity when take-it-easy.",
                "**CyclePhysiology documented** â€” formula in analytics + docs/TODAY_LIFE_ANIM.md.",
                "**Nutrition destination** â€” Meals Â· Supplements Â· BMR tabs (local-only SharedPreferences).",
                "**Nutrition quick meal chips** â€” Snack / Light / Meal / Big meal one-tap logs.",
                "**Supplement catalog** â€” creatine, magnesium, D, omega-3, electrolytes, protein, caffeine, multi.",
                "**Nutrition â†” Hydration jump** â€” todayâ€™s litres + Log opens Hydration.",
                "**Hold-+ radial** adds Nutrition alongside Workout Â· Live Â· Devices.",
                "**+ sheet** adds Nutrition Â· meals quick action.",
                "**More â†’ Body** lists Nutrition next to Health.",
                "**Hydration life droplets** bob around the vessel (token alpha bloom).",
                "**Hydration Reduce Motion** keeps droplets static / no float.",
                "**Your cards square tiles** â€” metric pairs side-by-side (1:1 frosted tiles).",
                "**Sleep / Hydration / Coupled** stay full-width rows (interaction destinations).",
                "**Square tile styling** â€” liquid vessel, overline, value, quiet subtitle.",
                "**Fitness Age while calibrating** â€” provisional estimate from â‰¥1 RHR night + age/sex.",
                "**Fitness Age honest caption** â€” Early estimate Â· N of last 7 nights â€” still calibrating.",
                "**VOâ‚‚max still shows** when waist unlocks, even on provisional Fitness Age.",
                "**Vitality live estimate** when weekly bank missing but â‰¥3 factors present.",
                "**Vitality caption** â€” Live estimate from available nights â€” still building weekly bank.",
                "**IntelligenceEngine** persists provisional Fitness Age (lowerConfidence) instead of blanking.",
                "**Wake settings AlarmSettingsCard** â€” Rest-tinted lacquer inset (styleful, not nested glow).",
                "**Wake alarm card** Rest hairline + surfaceInset (matches Today bedtime language).",
                "**Bedtime-first spirit kept** from 8.6.111 â€” recommended bedtime still leads Today Quick Alarm.",
                "**Cycle stays off bottom nav** â€” Today card + + sheet + More only.",
                "**Nutrition custom meal dialog** â€” label + kcal, on-device only.",
                "**Nutrition custom supplement dialog** â€” name + dose.",
                "**Meal / supplement delete** rows with 48dp targets.",
                "**BMR tab** shows Harrisâ€“Benedict base + cycle-adjusted when more fuel.",
                "**Suggested goal** BMR Ã— 1.4 labeled as moderate estimate (not medical).",
                "**Take-it-easy note** on Nutrition BMR when recoveryCapacityFactor < 1.",
                "**Health metrics card** Today dual-column / square polish retained beside Live session.",
                "**docs/TODAY_LIFE_ANIM.md** â€” animation specs + Reduce Motion contract.",
                "**Ship cadence encoded** â€” 50 â†’ 25imp+10add â†’ 10imp+25add rotating loop.",
                "**ANY_MODEL_CONTINUE + FABLE_DO_NOW** updated with new cadence + baseline.",
                "**No invented SpO2/BP** â€” vitals honesty unchanged.",
                "**No sleep staging math edits** this ship.",
                "**Soft bloom only via token alpha** â€” Design.md anti-glow respected.",
                "**TalkBack** Cycle card announces phase + day.",
                "**TalkBack** Nutrition tabs and quick-log chips labeled.",
                "**Arm settle** on slim Quick Alarm still honours Reduce Motion.",
                "**Exact-alarm toast** retained when Arm is blocked by system settings.",
                "**NutritionStore** keeps 90 days of local meals/supplements.",
                "**Cycle card Open** affordance clear secondary action.",
                "**Today alarm chapter hairline** kept under As-of before slim Quick Alarm.",
            ),
        ),
        Release(
            version = "8.6.111",
            title = "Bedtime-first Quick Alarm Â· Today & Wake style",
            date = "July 2026",
            items = listOf(
                "**Quick Alarm (Today)** â€” recommended bedtime hero + Arm; wake TimeChip at the bottom (no preset chips).",
                "**Quick Alarm (Sleep â†’ Alarm)** â€” same bedtime-first composition; wake edit + Â±15m window at the bottom.",
                "**Rest scenic wash** behind the Alarm bedtime glance (no glow, no nested cards).",
                "**Wake presets / window chips** removed from quick surfaces â€” edit in Wake settings or TimeChip.",
                "**Today bedtime card** uses Rest hairline + surfaceInset lacquer (soft, not purple).",
                "**Arm settle** on Today Off/Armed pill (Reduce Motion = instant).",
                "**Today footnote** shows Bed by HH:MM with Bedtime icon (not a second chip dump).",
                "**Alarm chapter hairline** under As-of before the Rest / alarm block on Today.",
                "**Cycle link** quieter secondary label (Cycle stays off the bottom nav).",
                "**Wake settings hero** leads with recommended bedtime, then wake window range.",
                "**Wake settings subtitle** is live â€” Off / Armed / Armed Â· may drift.",
                "**Your sleep plan** shows a large bedtime number (schedule cue, not a health target).",
                "**How it works** Rest overline on Wake settings explanation.",
                "**Exact-alarm warning** bordered soft pill before Arm (honesty kept).",
                "**Wake alarm card** icon tinted Rest (domain match, not gold-only chrome).",
                "**Wind-down Evening** overline uses Rest color.",
                "**Guaranteed by / May drift** honesty retained under Arm on quick Alarm.",
                "**Notifications off** warning still shows when Armed.",
                "**Strap buzz / Test / extras** demoted to secondary rows under the bedtime hero.",
                "**Custom soonest** caption only when custom alarms are enabled.",
                "**TalkBack** bedtime heading includes aim + wake on Today and Alarm.",
                "**docs/TODAY_STYLE_50.md** â€” fifty concrete Today style improvements.",
                "**docs/ALARM_STYLE_50.md** â€” fifty concrete Alarm / Wake style improvements.",
                "**Arm on Today** toasts when exact-alarm permission blocks scheduling.",
                "**Wake settings** Why-an-alarm empty state gets a quiet Rest hairline separator.",
            ),
        ),
        Release(
            version = "8.6.110",
            title = "Wake settings Â· Alarm chrome polish",
            date = "July 2026",
            items = listOf(
                "**Wake settings** replaces â€œMore detail / Full editorâ€ naming (Today + Alarm + pushed screen).",
                "**Sleep|Alarm tabs** drop the underline; selection wash only (no triple emphasis).",
                "**Inactive Sleep|Alarm tab** uses secondary text (not ash) so sky packs stay readable.",
                "**Tab a11y** says â€œAlarm tabâ€ / â€œSleep tabâ€ (not â€œSleep tab Alarmâ€).",
                "**Reduce Motion** freezes the segment breath wash.",
                "**Segment padding** tightened for Fold cover width.",
                "**Sleepâ†”Alarm page motion** follows real forward/back direction.",
                "**Travel TZ note** shows on Alarm as well as Sleep.",
                "**Arm CTA** stays clear when Off â€” strap offline honesty moves under Test buzz.",
                "**Notifications off** warns when Armed (deadline cannot sound).",
                "**Buzz ACK / buzz status** surfaces on the Alarm summary when Live has a note.",
                "**Hero wake clock** is a TalkBack heading; preset row has a grouping overline.",
                "**Wake presets** keep stronger inactive contrast on sky.",
                "**Rest bridge** aims at earliest wake (matches bed cue / sleep plan).",
                "**Wake settings CTA** names turn-back Â· custom Â· wind-down extras.",
                "**WHOOP 4 / 5 / MG** copy (no stale WHOOP 3 strap-buzz line).",
                "**Exact-alarm cue** appears before Arm on Wake settings for first-timers.",
                "**How smart wake works** sits near the top of Wake settings.",
                "**Turn-back tonight preview** shows watch window after the deadline.",
                "**Charge threshold** explains green Charge on Today.",
                "**Custom alarm rename** (tap label) + **Remove confirm** dialog.",
                "**Weekdays / Weekends / Every day** presets on weekday pickers.",
                "**Strap wake-alarm** tip when off; Watch icon distinct from custom Schedule icon.",
                "**Wind-down** shows derived fire time on the card.",
                "**docs/ALARM_OEM_QUIRKS.md** â€” OEM exact / battery / notification traps.",
            ),
        ),
        Release(
            version = "8.6.109",
            title = "Sleep tracker back Â· alarm buzz clarity",
            date = "July 2026",
            items = listOf(
                "**Sleep tracker findable again** â€” Alarm tab no longer feels like nights vanished.",
                "**Last night peek** on Alarm with one tap back to stages / ledger / trends.",
                "**Stages move up** â€” hypnogram sits right under the night hero, before Rest drivers.",
                "**Night map chips** â€” Stages Â· Ledger Â· Trends Â· Tools jump to each surface.",
                "**Tools â†’ Alarm** verb switches the Sleep|Alarm tab (not only the full editor).",
                "**Empty Set Alarm** opens the Alarm tab instead of jumping into More detail.",
                "**Sleep subtitle** names stages Â· ledger Â· trends so the tracker job is obvious.",
                "**Alarm subtitle is live** â€” Off / Armed / may-drift, not a static wake line.",
                "**Stage-less night honesty** â€” tips â—€ older nights; history is never â€œno nightsâ€.",
                "**Stages vs typical** empty tip when the browsed night has no stage minutes.",
                "**Quick alarm on Today** shows Off/Armed, Window Xm countdown, and selection when Off.",
                "**Today â†’ Sleep Alarm** link naming matches the Sleep|Alarm tab.",
                "**Arm settle** on the Alarm status pill (Reduce Motion keeps it instant).",
                "**Rest bridge hairline** under the Alarm clock when Rest / need / wake can be stated.",
                "**Strap buzz + Test buzz** say the phone deadline still fires alongside.",
                "**Boot re-arm honesty** â€” phone deadline survives reboot; strap buzz needs reconnect.",
                "**Muted notification** footnote when Armed (check NOOP alarm channel).",
                "**Exact after grant** â€” calm â€œArm againâ€ cue when Settings returns with permission on.",
                "**Wake rested** copy ties early cue to Charge / sleep-need; hard deadline still stands.",
                "**Next fire** uses the shared soonest helper so soft window vs custom is clear.",
                "**MG Test buzz** still points at Buzz ACK; Whoop4 path notes phone deadline independence.",
                "**docs/ALARM_BUZZ_20.md** â€” twenty concrete alarm + buzz improvements for NOOP.",
            ),
        ),
        Release(
            version = "8.6.108",
            title = "Alarm page Â· wake at a glance",
            date = "July 2026",
            items = listOf(
                "**Alarm status** is a bordered pill â€” Armed, Off, or Armed Â· may drift.",
                "**Wake range** shows earliestâ†’deadline under the big wake clock.",
                "**Countdown** uses the same next-alarm helper as Today (Xh Ym).",
                "**Guaranteed by** / **May drift** caption; tap opens exact-alarm Settings.",
                "**Earliest wake** time picker on the Sleep | Alarm summary (no full editor required).",
                "**Wake presets** 6:30 / 7 / 7:30 / 8 restored on Alarm (shared with Today Quick alarm).",
                "**Window presets** 15 / 30 / 45 / 60 / 90 with selection ring + haptic.",
                "**Soft window max** raised to 90 minutes (store + full-editor stepper agree).",
                "**Â±15m** dims at bounds and toasts the real 15â€“90 min range (no silent clamp).",
                "**Window Xm** copy on the summary; aim / bed split onto two lines.",
                "**Bed cue** uses earliest wake so it matches the Sleep plan card.",
                "**Arm failure** opens exact-alarm Settings, not Toast-only.",
                "**Exact permission** footnote on the summary is tappable.",
                "**Strap buzz / Turn-back / Wake rested / Wind-down** use clean labels; on-state via button kind.",
                "**Wind-down** toggle sits on the Alarm summary (not only in More detail).",
                "**Test buzz** toast is rider-facing (no enc= jargon); MG wake called experimental.",
                "**More detail** CTA includes next custom alarm time when one is armed.",
                "**Custom alarms** empty teaching copy + â€œAdd a fixed timeâ€; Remove hits â‰¥48dp.",
                "**Custom alarm cap** shows â€œLimit 5â€ instead of a dead Add row.",
                "**Full editor** drops the duplicate Wake switch beside the time chip.",
                "**Sleep | Alarm** selected tab drops the glow text-shadow.",
                "**Off empty** keeps one calm why-alarm sentence under the controls.",
            ),
        ),
        Release(
            version = "8.6.107",
            title = "Charge once Â· HRV honesty Â· useful +",
            date = "July 2026",
            items = listOf(
                "**Charging overlay** fires once per plug-in session â€” no more replay on every +1%.",
                "**Charge-bit flicker** no longer clears the session (same hysteresis idea as battery alerts).",
                "**Dismiss** during charge stays dismissed until you unplug (or a real multi-point drop).",
                "**SoC inference** needs a â‰¥2 point drop before clearing â€œon chargerâ€.",
                "**Live ring** keeps updating percent while the overlay is up without restarting the entrance.",
                "**HRV tiles** say HRV Â· RMSSD (WHOOP path is RMSSD, not SDNN).",
                "**Key Metrics** HRV label matches RMSSD.",
                "**Trends** HRV caption notes overnight RMSSD (not SDNN).",
                "**Health** HRV label matches RMSSD.",
                "**Insights** outcome label matches RMSSD.",
                "**Today vitals chip** says HRV Â· RMSSD when a value is present.",
                "**+ quick actions** add Live HR and Devices Â· reconnect.",
                "**Hold-+ dial** swaps Journal for Devices (reconnect without digging).",
                "**Journal** stays one tap away in the + sheet.",
                "**Hold coach / sheet copy** match Workout Â· Live Â· Devices.",
                "**Nav inactive labels** a bit brighter so ash tabs donâ€™t look dead.",
                "**Settings** toggle for temporary Test-buzz auto-diag to the PC collector.",
                "**Connection help** explains pairing-rejected / Forget canâ€™t be reversed + blue LED steps.",
                "**Research queue** Vishnu raw-signal / scoring PRs logged for the improvement repo (not default MAIN).",
                "**Ship rule** MAIN patch notes must list at least 20 user-facing items before publish.",
            ),
        ),
        Release(
            version = "8.6.106",
            title = "Buzz bond + Cycle off the bar",
            date = "July 2026",
            items = listOf(
                "**Test buzz** turns Alongside off and reconnects exclusive so WHOOP 4 and 5/MG can form a full bond before the motor fires.",
                "**Auto-diag** after Test buzz pushes strap-log lines to the PC collector (temporary).",
                "**Cycle** moves out of the bottom bar into + quick actions and Today when enabled.",
                "**Themes** return in + quick actions (next pack). Sleep | Alarm tabs get a soft segmented control.",
                "**AltStore** source points at Newbbsss/noop (IPA still needs a Mac build to match Android).",
            ),
        ),
        Release(
            version = "8.6.105",
            title = "Balanced Cycle nav crescents",
            date = "July 2026",
            items = listOf(
                "**Nav bar** gives the 3-tab Cycle crescent more width and slightly compact icons so it no longer looks heavier than the 2-tab side.",
            ),
        ),
        Release(
            version = "8.6.104",
            title = "Fold cover + glow fits",
            date = "July 2026",
            items = listOf(
                "**Centre + glow** scales down on short Fold-cover heights so it no longer clips under the system taskbar.",
            ),
        ),
        Release(
            version = "8.6.103",
            title = "Quieter + when Reduce Motion is on",
            date = "July 2026",
            items = listOf(
                "**Reduce Motion** dims the centre + aura to a soft static wash instead of leaving it nearly full-bright.",
            ),
        ),
        Release(
            version = "8.6.102",
            title = "Richer hold-+ dial bloom",
            date = "July 2026",
            items = listOf(
                "**Hold-+ dial** particles and corona are denser so the bloom matches the centre + glow intensity (Reduce Motion still stays static).",
            ),
        ),
        Release(
            version = "8.6.101",
            title = "Aim for hours by wake",
            date = "July 2026",
            items = listOf(
                "**Sleep Rest** and the **Alarm page** now share one â€œaim for Xh by wakeâ€ line from your personal sleep need â€” bed time follows that same need.",
            ),
        ),
        Release(
            version = "8.6.100",
            title = "Turn-back on the Alarm page",
            date = "July 2026",
            items = listOf(
                "**Alarm page** now toggles Turn-back and Wake when rested without opening More detail (thresholds still live in the full editor).",
            ),
        ),
        Release(
            version = "8.6.99",
            title = "Custom alarm count on Alarm",
            date = "July 2026",
            items = listOf(
                "**Alarm page** shows how many custom alarms are on (or off) in the summary and More detail line â€” no need to open the editor to check.",
            ),
        ),
        Release(
            version = "8.6.98",
            title = "Travel TZ alarm honesty",
            date = "July 2026",
            items = listOf(
                "**Todayâ€™s next-alarm line** uses the same wall-clock wake window as the Alarm page, so a timezone change canâ€™t shift one without the other.",
                "**After travel**, NOOP recomputes the phone wake from your minute-of-day setting instead of a stale absolute time.",
            ),
        ),
        Release(
            version = "8.6.97",
            title = "Trends remembers your range",
            date = "July 2026",
            items = listOf(
                "**Trends** keeps your last W / M / 3M / 6M / 1Y / ALL chip when you leave and come back.",
            ),
        ),
        Release(
            version = "8.6.96",
            title = "Armed honesty without exact alarm",
            date = "July 2026",
            items = listOf(
                "**Wake status** says Armed Â· may drift (not plain Armed) when exact-alarm permission is off, and re-checks on resume.",
                "**Alarm editor** no longer promises a guaranteed wake until exact access is granted.",
            ),
        ),
        Release(
            version = "8.6.95",
            title = "Quick alarm 12h chips",
            date = "July 2026",
            items = listOf(
                "**Today Quick alarm** presets (6:30 / 7 / 7:30 / 8) follow the phoneâ€™s 12-hour or 24-hour clock.",
            ),
        ),
        Release(
            version = "8.6.94",
            title = "One sleep-debt number",
            date = "July 2026",
            items = listOf(
                "**Sleep debt:** Hours vs Needed and the detail chart now use the same 14-night ledger as the Sleep-debt card (no more 0.0h vs âˆ’7h clash).",
                "**Tonight short** on Hours vs Needed is only that nightâ€™s gap; **Ledger** is the running balance.",
            ),
        ),
        Release(
            version = "8.6.93",
            title = "Active strap always obvious",
            date = "July 2026",
            items = listOf(
                "**Devices** opens with who is Active for live data and commands.",
                "**Settings â†’ Strap** names the active band and jumps to Manage devices.",
            ),
        ),
        Release(
            version = "8.6.92",
            title = "Alarm tab tick Â· denser wake page",
            date = "July 2026",
            items = listOf(
                "**Sleep | Alarm** taps give a light haptic; Reduce Motion still kills glow/slide only.",
                "**Alarm page** packs honesty + strap status into one line; tighter spacing, no card stack.",
            ),
        ),
        Release(
            version = "8.6.91",
            title = "Chart axis honesty",
            date = "July 2026",
            items = listOf(
                "**Sleep-debt sparkline** shows Â± hours on the Y rail (no bare bars).",
                "**Today HR** Y rail prints bpm on first open; Stress scrub tip marks **15m** steps vs WHOOPâ€™s continuous curve.",
            ),
        ),
        Release(
            version = "8.6.90",
            title = "Alarm honesty Â· buzz bond prompt",
            date = "July 2026",
            items = listOf(
                "**Alarm honesty:** phone rings at wake; strap buzz called best-effort / MG wake experimental.",
                "**Test buzz** always fires when connected â€” if MG lacks exclusive bond it re-prompts Android pairing, then you retry.",
            ),
        ),
        Release(
            version = "8.6.89",
            title = "Tailnet friends invite Â· iOS Rest/buzz align",
            date = "July 2026",
            items = listOf(
                "**Invite friends (Friends network):** Settings â†’ About / More â†’ Friends network â€” private LAN/Tailscale pipe + invite codes. Not the GitHub update path. No cloud accounts.",
                "**Copy AltStore source** from Friends network. iOS/macOS Rest + MG buzz paths aligned with Android (whoop scale, deep floor, Ryan no-resp buzz).",
            ),
        ),
        Release(
            version = "8.6.88",
            title = "MG buzz Ryan write-type Â· Alarm | page",
            date = "July 2026",
            items = listOf(
                "**MG buzz:** match Ryan whoop_buzz.py â€” maverick notify without-response first, then acked + loop1 fallback; Buzz ACK surfaces in status/log.",
                "**Alarm tabs** back to lit Sleep | Alarm with soft underline (not heavy pill). Alarm page: big wake clock, Arm primary, cleaner Test buzz.",
            ),
        ),
        Release(
            version = "8.6.87",
            title = "Charge fix Â· MG buzz Ryan path Â· Alarm tabs",
            date = "July 2026",
            items = listOf(
                "**Charge restored:** logisticZ0 back to -0.20 (the 0.03 nudge inverted the math and crushed scores).",
                "**Rest ~10 high:** soft 0.90 WHOOP-align scale on the composite; staging untouched.",
                "**MG buzz = Ryan golden:** overallLoop=0 notify + RUN_ALARM rev2 [0x02,1], matching Swift/whoop_frame â€” not OpenStrap loop=1.",
                "**Sleep|Alarm tabs:** sliding lit pill + breath. Charts: optional Y-axis units (bpm) on Today HR + full-day timeline.",
            ),
        ),
        Release(
            version = "8.6.86",
            title = "MG buzz: overallLoop + Test buzz",
            date = "July 2026",
            items = listOf(
                "**MG Test buzz hardened:** maverick haptic now uses overallLoop=1 (then retries golden loop0 + RUN_ALARM). Detects WHOOP4-on-MG mismatch and forces 5.0/MG protocol.",
                "**Test strap buzz** back on Sleep â†’ Alarm and Settings â†’ Strap, with bond/framing toast so silent fails are diagnosable.",
            ),
        ),
        Release(
            version = "8.6.85",
            title = "Charge/Rest align Â· Sleep plan Â· nature themes",
            date = "July 2026",
            items = listOf(
                "**Charge nudged up / Rest nudged down** toward WHOOP without re-staging sleep.",
                "**Sleep | Alarm** is a lit center switch (pink/rest glow). Alarm page is Tonight's sleep with suggested bed + wake; More detail opens full alarm. Alarms removed from More.",
                "**+ glow follows each theme** (not forced gold); coin is surface lacquer, not black. Nature packs: Meadow Bloom, Cherry Grove, Willow Mist with petal/leaf motif.",
                "**Day dots smaller**, Fold nav fade softer, Strength Trainer muscle map more anatomical.",
            ),
        ),
        Release(
            version = "8.6.84",
            title = "Protocol toggle reconnect",
            date = "July 2026",
            items = listOf(
                "**Command protocol** in Settings now reconnects cleanly when you switch Auto / 4.0 / 5.0Â·MG (so the new framing applies immediately).",
            ),
        ),
        Release(
            version = "8.6.83",
            title = "MG buzz protocol Â· bigger + glow",
            date = "July 2026",
            items = listOf(
                "**MG strap buzz:** Auto command protocol now prefers 5.0/MG when both GATT services appear (was wrongly using WHOOP 4 framing). Settings â†’ Strap â†’ Command protocol lets you force Auto / 4.0 / 5.0Â·MG.",
                "**Centre + glow is larger** and the nav crescents take a soft gold rim so the middle reads as one bloom, not a black cutout.",
            ),
        ),
        Release(
            version = "8.6.82",
            title = "Alarm window Â±15m haptic",
            date = "July 2026",
            items = listOf(
                "**Alarm soft-window Â±15m** now gives a light haptic tick when the window actually changes.",
            ),
        ),
        Release(
            version = "8.6.81",
            title = "Wake clock stays off Charge gold",
            date = "July 2026",
            items = listOf(
                "**Alarm wake numeral** keeps a cool sleep accent when Rest shares the Charge/gold family, so it no longer reads as Charge.",
            ),
        ),
        Release(
            version = "8.6.80",
            title = "Sleep|Alarm tab clearer on sky",
            date = "July 2026",
            items = listOf(
                "**Sleep|Alarm segmented control** sits on a raised track with a stronger edge so it stays readable over the day-cycle sky.",
            ),
        ),
        Release(
            version = "8.6.79",
            title = "Intense + glow Â· crescent reach Â· MG buzz",
            date = "July 2026",
            items = listOf(
                "**Centre + is an intense gold glow** â€” no spiral rings or orbiting particles. Crescents extend toward the coin (coin stays full size).",
                "**Today blur sits tighter on the header** so cards keep more space. Profile, battery, and header discs share one 34dp size.",
                "**Bottom fade softens into the Samsung nav** instead of a hard shadow cut.",
                "**MG strap buzz hardened** (acked retry) plus Alarm page Test buzz and bond honesty.",
            ),
        ),
        Release(
            version = "8.6.78",
            title = "Louder + aura Â· crescent kiss Â· Alarm page",
            date = "July 2026",
            items = listOf(
                "**Centre + glow emanates more.** Wider champagne-gold aura, soft rings, denser particles behind the nav (Reduce Motion stays static).",
                "**Crescents reach the bright core.** Narrower gutter and deeper bites so island tips nearly touch the hot glow.",
                "**Alarm page is clearer.** Armed/Off pill, larger wake-by, Â±15 min window, exact-alarm honesty, cleaner presets.",
                "**Fable list grew** with near-term items and a long-horizon backlog for the next ships.",
            ),
        ),
        Release(
            version = "8.6.77",
            title = "Calmer stress Â· premium + aura Â· soft fades",
            date = "July 2026",
            items = listOf(
                "**Stress reads cooler vs WHOOP.** Stronger motion/workout damp and a lower calm floor so daytime tips sit nearer WHOOP's ~0.7 band (chart spikes stay honest).",
                "**Centre + is a true round lacquer coin** with a soft champagneâ†’goldâ†’amber aura behind the nav â€” no firework rings, crescents still kiss.",
                "**Hold-+ dial lighting** uses a cooler mist corona and tasteful rim sparks; Reduce Motion stays static.",
                "**Today fades** sit higher at the top and underlap the nav crescents at the bottom instead of a hard cut above the bar.",
            ),
        ),
        Release(
            version = "8.6.76",
            title = "Radiating + Â· tight crescents Â· real sleep UI",
            date = "July 2026",
            items = listOf(
                "**Centre + finally glows.** Radiating gold particles + expanding rings behind the nav â€” not clipped by the gutter.",
                "**Crescents kiss the coin.** Deeper bites and a narrower gutter so the islands cup the +.",
                "**Sleep shows four stage rows** (Awake / Light / Deep / REM) even when old bank JSON lacked timed segments â€” no more staircase fallback.",
                "**MG sleep staging defaults to V2** (DREAMT-retuned). Re-open Sleep after update so nights re-stage; all-light was the old V1 path.",
            ),
        ),
        Release(
            version = "8.6.74",
            title = "Honest stages + Sleep / Alarm pages",
            date = "July 2026",
            items = listOf(
                "**Sleep stages lean toward strap reality.** Wider deep/REM bands and a softer late-deep prior so a sparse MG night is not stuck near 2% deep / 0% REM.",
                "**Sleep and Alarm are separate pages** inside the Sleep tab: night first, wake controls on Alarm.",
                "**Quick alarm matches the WHOOP glance.** Large wake-by time, window caption, arm toggle, and presets on the Alarm page.",
                "**One sleep-debt ledger.** Duplicate debt chrome under Sleep is gone; debug and MAIN share the same staging source.",
            ),
        ),
        Release(
            version = "8.6.73",
            ...
            date = "July 2026",
            items = listOf(
                "**Today soft-fades at both ends.** Content dissolves under the status cluster and under the nav/+ zone â€” real composite fade, not a hard black cut.",
                "**Nav islands cast soft shadows on both ends** with Fold edge falloff on the glass veil, so the bar is no longer a black slab.",
                "**The centre + is fatter with a real gold glow** â€” wide halo, hot core, champagne spark. Tap opens the menu; hold opens the dial.",
                "**Less redundancy near +.** One tap menu (Updates Â· Workouts Â· Breathe); Themes stay in Settings.",
            ),
        ),
        Release(
            version = "8.6.70",
            title = "Wake alarms within reach",
            date = "July 2026",
            items = listOf(
                "**Set or manage wake alarms from Today and Sleep.** Both screens keep a clear alarm action visible, even before you arm one.",
                "**Today is calmer.** Stress, Fitness Age, and Vitality moved into the compact Key Metrics grid, replacing the duplicate full-width card stack.",
                "**The centre + is easier to spot.** Its one allowed gold aura is larger and brighter, while Reduce Motion keeps it static.",
                "**Custom alarms stay honest.** NOOP will not show an alarm as enabled when Android has not granted exact-alarm access.",
            ),
        ),
        Release(
            version = "8.6.21",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**WHOOP 5/MG test panel.** Debug testers can find the opt-in experimental controls under Settings â†’ Advanced. Every switch stays off by default and only affects a 5/MG strap.",
            ),
        ),
        Release(
            version = "8.6.19",
            ...
            date = "July 2026",
            items = listOf(
                "**Full-screen charging.** When your strap starts charging, a full-screen AirPods-style ring opens: big %, pulse bolt, **time remaining to full**, runtime estimate, and honest â€œcharge limit not on open BLEâ€.",
                "**Ding on charge.** A short two-note chime plays when charging starts (honours silent/vibrate).",
                "**Any screen.** The overlay works from Today, Live, or anywhere â€” not only the Live list card. Tap the Live charge card to re-open full screen.",
            ),
        ),
        Release(
            version = "8.6.17",
            title = "No random glows Â· dual-scale WHOOP Â· Impeccable",
            date = "July 2026",
            items = listOf(
                "**What's new on open.** Dual-scale compare, battery soft reboot, cleaner chrome.",
                "**NOOP vs WHOOP app is dual-scale.** Day Strain **14.7/21 Â· â‰ˆ70%** next to Effort **/100 Â· â‰ˆ/21**.",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**Back up on iPhone without fighting the folder picker.** Backup & Sync now offers *Use NOOP's own folder* â€” a one-tap backup saved inside NOOP and visible in the Files app, for when iOS won't let you pick a folder.",
                ...
                "**Your phone backup alarm no longer depends on wrist alerts.** If you set a smart alarm, the backup notification is scheduled even if you never turned wrist alerts on â€” and NOOP now warns you when a strap keeps refusing the alarm time.",
            ),
        ),
        Release(
            version = "8.3.4",
            ...
            date = "July 2026",
            items = listOf(
                "**A finished sync no longer looks like a failure.** After your strap hands over its history, NOOP could flash a \"no banked history â€” charge to 100%\" warning even though it had just offloaded hundreds of records. That false alarm is gone â€” a caught-up sync now reads as caught up.",
            ),
        ),
        Release(
            version = "8.3.3",
            title = "Your macOS data is back â€” and full French",
            date = "July 2026",
            items = listOf(
                "**macOS: your history is back.** Upgrading the Mac app could open an empty database â€” your data was never lost, just looked for in the wrong place. It now finds your existing store and imports it on first launch (the original is left untouched).",
                "**Full French.** The app is now completely translated into French, alongside German and Spanish.",
                "**Sleep stages read right.** On nights with fine-grained staging the stage graphic no longer collapses into a single row of dots â€” it draws as a continuous timeline again.",
            ),
        ),
        Release(
            version = "8.3.2",
            ...
            date = "July 2026",
            items = listOf(
                "**Imported workout files show up.** A FIT / GPX / TCX file you import now appears in Workouts â€” it was saved and counted, but the list wasn't reading that source.",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**Card transparency.** Settings â†’ Appearance now lets you dial how see-through the cards are â€” solid to clear, saved and applied live.",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**Easier to find.** Settings â†’ Backup & restore now links straight to Automatic backups.",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**NOOP en espaÃ±ol, and in Chinese.** On iPhone and Mac, Spanish and Chinese (Simplified and Traditional) are complete, and Italian is refreshed. Community-contributed, with thanks. Android translations are on the roadmap.",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**The About screen shows the right version.** The version pill in Settings â†’ About now reads the app's real version, so it can't drift out of date again.",
            )),
        Release(
            version = "7.0.0",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "**NOOP is back on GitHub** - and so is **Check for updates**. The in-app update check and the **Settings â†’ About** \"project home\" link now point at github.com/NoopApp/noop again, where releases live (noop.fans stays as a mirror). It's still on-device and only runs when you tap - nothing about you is ever sent.",
            )),
        Release(
            version = "5.2.4",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**A tidier More page.** Everything's grouped under **Insights Â· Body Â· Data Â· App** in clean cards, one tap from the More tab.",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "**A cleaner home.** The bottom bar is now four tidy tabs - **Today Â· Trends Â· Sleep Â· More** - and the quick-action **+** has moved up to the top-right of your home screen, balancing your profile on the left. Same actions (start a workout, log your journal, breathe), much less clutter.",
                "**A new Updates inbox.** Tap the **bell** in the top-right to see what's new - fresh readings and history that landed, what's-new notes, and any home cards you've tucked away. A small gold badge shows when there's something unread. Hit the **Ã—** on a home card to send it to the inbox, and pull it back any time with **Restore to Today**.",
                "**Make it yours - a profile photo.** Tap your profile (top-left) â†’ **Settings â†’ Profile photo** and choose a picture. It shows on your home screen and stays **only on your device** - NOOP is offline, so it's never uploaded.",
                "**Cleaner, crisper design.** We blended the glass-and-material look, dialled back the glow across the whole app for sharper lines, evened up the spacing around the little pill toggles, and onboarding now shows up front that you can switch **Light Â· Dark Â· System** whenever you like (**Settings â†’ Appearance**).",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "**The big idea.** Everyone else shows you a score their cloud computed, behind a subscription. NOOP reads your strap's raw signals - beat-to-beat timing, red/IR PPG, motion, skin temperature - and does all the maths on your own device, free and offline. And it's the only one that can actually breathe you back down. Seven new things below, plus a tidier home: everything now lives under five places - **Today Â· What Moves You Â· Health Â· Devices & Sources Â· Settings**.",
                "**Haptic biofeedback - the strap that breathes you down.** Your wrist motor can now pace your breathing with the screen off. Find your personal calm pace (open **Breathe â†’ Resonance â†’ Find your resonance pace**, pick the ~13-min or ~7-min sweep), then breathe to the buzz. Mid-stress, tap **Calm me Â· 3 min** for a felt metronome just below your heart rate. Optional passive check-ins: **Settings â†’ Automations â†’ Stress check-ins (haptic)** (off by default).",
                ...
                "**Lab Book - your own private logbook.** Type in your bloods, blood pressure, scan values or doctor's-visit notes (or import a CSV), see each marker's trend, and line a marker up against a wearable signal with **Compare with a signal**. It's a notebook, not a medical service - NOOP stores and lines up the numbers *you* enter, never tests, reads or diagnoses them, and it all stays on your device. Open **Health â†’ Lab Book**.",
                "**Rhythm (experimental).** A picture of your beat-to-beat timing - a PoincarÃ© scatter with plain descriptive stats. It's a visualisation, not a verdict: not an ECG, not a diagnosis, can't detect any heart condition. Off by default behind a consent screen: **Settings â†’ Rhythm â†’ Turn on Rhythm**.",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**New: feel the time - Haptic Clock.** Your strap can now buzz out the current time: long buzzes for tens, short for units, hours then minutes. Tap \"Buzz the time on your strap\" in Settings â†’ Diagnostics. (#460.)",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "**New: import a Xiaomi Mi Band.** Bring a Mi Band / Smart Band 8, 9 or 10's full history - steps, heart rate, resting HR, sleep stages, SpOâ‚‚, stress and sleep score - straight from the Mi Fitness app's on-device database. No Bluetooth, no Xiaomi account; it gets its own page with a per-night hypnogram and shows up across Explore, Compare and Correlations. (Thanks @matt - #35.)",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**The strap log is now in Settings on iPhone too** (Settings â†’ Strap â†’ Copy / Save), matching Mac - easy to grab for a bug report without hunting on the Live screen. (#509)",
            ),
        ),
        Release(
            version = "4.5.4",
            ...
            date = "June 2026",
            items = listOf(
                "Added a **Strap log** shortcut to **Settings â†’ Strap** on Mac - Copy or Save the log right from Settings instead of hunting for it on the Live screen. (Android already had it in Settings.)",
            ),
        ),
        Release(
            version = "4.5.3",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "**You can now flip every gauge, ring, chart and scale to the traditional red â†’ amber â†’ green readiness palette** - the colourful style people know. Settings â†’ Appearance â†’ **Chart colours**: pick **Titanium** (the brand gold/amber/blue ramps, the default) or **Classic**. Classic re-colours the *data* - recovery goes redâ†’green, HR zones run coolâ†’hot, stress is greenâ†’red, sleep gets a purple REM band - while leaving the app's chrome (surfaces, text, buttons) exactly as it is. It works in **both Light and Dark**. Nothing about your numbers changes; only how they're coloured.",
            ),
        ),
        Release(
            version = "4.3.2",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "**NOOP now has a full Light theme, and you can switch any time.** Settings â†’ Appearance lets you pick **System** (follow your phone), **Light**, or **Dark**. The new Light look is \"warm paper & gold\" - a soft warm-white canvas with crisp navy-ink text and the signature gold deepened so it stays legible on white. Every surface was re-done for it, not just inverted: the ring gauges, frosted cards (now lifted with a soft shadow instead of a glow), charts, the scenic hero, the home-screen widget and even the status bar all adapt. Dark stays exactly as it was. Same data, same layout - your choice of finish.",
            ),
        ),
        Release(
            version = "4.2.13",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "**Your exported Trends report now includes Respiratory rate and Skin temperature.** Two more measured-from-the-strap rows sit alongside HRV, Resting HR, Sleep, Recovery and Strain - each with its average, range, daily trend and a per-day sparkline over the window you pick. Respiratory rate flags a rising trend as \"worth a look\" (a higher resting breathing rate can signal illness or strain); skin temperature is shown as the signed deviation from your own baseline (e.g. +0.3 Â°C), with no good/bad verdict - either direction can matter. Thanks @subscriptiondestroyer (#457).",
            ),
        ),
        Release(
            version = "4.2.5",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "A gentle move reminder, if you want one. Turn it on in Settings â†’ Automations and NOOP buzzes your strap after you've been sitting still too long (your threshold, default 45 min), within hours you choose (default 9-5), with a cooldown you set. Off by default, runs from the motion already on your strap, and respects quiet hours and only-when-worn. Thanks @cbarrado (#419).",
            ),
        ),
        Release(
            version = "4.2.0",
        ...
        Release(
            ...
            items = listOf(
                ...
                "Clearer diagnostics for non-WHOOP heart-rate straps. Connecting a generic strap (Polar, Wahoo, Coospoâ€¦) now records every step of the Bluetooth handshake in the strap log - scan, connect, service discovery, notification enable, first reading - so a \"connected but no data\" report can actually be diagnosed. Adds a single auto-retry on the common Android 133 connect error. Thanks @pilleuspulcher-blip (#421).",
                "UI polish: the \"vs previous month\" comparison in Explore no longer clips; the bedtime/wake time-scale label isn't cut off; the Insights day order is now Yesterday â†’ Today â†’ Tomorrow; and the \"Journal\" heading stays on one line. Thanks @nhe (#443).",
            ),
        ),
        Release(
            version = "4.0.2",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Today's Effort now updates live through the day. The Effort ring recomputes over today's heart rate as it happens (midnight â†’ now), instead of showing yesterday's completed-day value - or a stale 0.0 early in the morning - until the next full re-score. Thanks @rad182 (#402).",
        ...
        Release(
            ...
            items = listOf(
                ...
                "Optional: see your estimated VOâ‚‚max. Add your waist measurement in Settings and NOOP will also show an estimated VOâ‚‚max alongside your Fitness Age. (Your Fitness Age itself never needs it.)",
                "Honest by design. Every new number carries a Â± band and a plain \"this is a wellness estimate, not a clinical age\" line. These build over a week or two of wear.",
            ),
        ),
        Release(
            version = "3.9.1",
        ...
        Release(
            ...
            items = listOf(
                ...
                "Insights â€œBy Dayâ€ stays smooth with years of history: tapping All with a big imported history used to build every day at once and could freeze the app. The list now renders only what's on screen, so it scrolls smoothly no matter how many days you've imported. Thanks @maddognik (#345).",
        ...
        Release(
            ...
            items = listOf(
                ...
                "New: a brand-new machined-titanium app icon with a gold core - plus a Settings â†’ App Icon toggle to switch to a darker \"blued-titanium\" version.",
        ...
        Release(
            version = "2.18.5",
            title = "Today tiles no longer cut their value to \"10â€¦\"",
            date = "June 2026",
            items = listOf(
                "Fixed: on phones, Today tiles that show a sparkline (Charge, Rest, Respiratory, HRVâ€¦) were truncating their value to \"10â€¦\" or \"15â€¦\" because the value and the inline trend line were competing for width. The value now shrinks to fit the way it already does on Mac/iPhone, so it always reads in full. Thanks @asemfahad (#332).",
            ),
        ),
        Release(
            version = "2.18.4",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "New (iPhone): a toggle to keep your live heart rate out of the Dynamic Island and Lock Screen - Settings â†’ Strap â†’ \"Live heart rate in Dynamic Island\". On by default; flip it off and any live-HR activity already showing clears within a moment. Thanks @gingerbeardman (#336).",
            ),
        ),
        Release(
            version = "2.18.0",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Fixed (Android): some Today tiles cut their value off to \"â€¦\" (Effort, Rest, Respiratory, and the Last Workouts durations) - the value now shrinks to fit the tile instead of truncating, matching the Mac/iPhone behaviour. Thanks @asemfahad (#332).",
            ),
        ),
        Release(
            version = "2.16.0",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Fixed (Android): the **Last Workouts** tiles on Today no longer truncate the workout duration to \"1â€¦\" - the duration now gets the room it needs next to the calorie chip. Thanks @nhe (#319).",
            ),
        ),
        Release(
            version = "2.15.0",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Fixed: the Insights tab crashed for anyone with journal entries - a text-matching pattern used a flag that works on a computer but not on Androidâ€™s engine, so it threw the moment you opened Insights. Fixed. Thanks @pilleuspulcher-blip and @maddognik (#224/#267).",
                ...
                "Fixed (WHOOP 5/MG): the experimental deep-data unlock now requires the full encrypted bond. A live-HR-only link (strap still owned by the official app) canâ€™t carry the unlock, so the button waits for a real bond and tells you to free the strap from the official app first. Thanks @Joshsil03 (#269).",
                "New: the â€˜Start a workoutâ€™ sport list now shows a scrollbar so you can tell it scrolls, and adds Tennis, Squash and Table tennis. Thanks @nhe (#265).",
                "New: the Intelligence â€˜By Dayâ€™ list gets a W / M / 3M / 6M / 1Y / ALL range filter to narrow to a recent window. Thanks @ujix (#252).",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "New: each Readiness signal now shows the numbers behind it - e.g. â€˜HRV 72 vs 60 msâ€™, â€˜Resting HR 46 vs 52 bpmâ€™, â€˜Training load 7d 10.0 / 28d 10.0â€™ - so you can see exactly why a signal is flagged, not just the label. Thanks @khalilkm01.",
        ...
        Release(
            ...
            items = listOf(
                ...
                "Fixed (iPhone): if a NOOP backup from another platform had been restored (e.g. an Android backup onto an iPhone), the app could get permanently stuck on â€œstore not readyâ€. NOOP now recovers automatically on the next launch, and declines such a backup at import time with a clear explanation. To move history across platforms, use the WHOOP-format CSV export instead. Thanks @NoahMcE. (#222)",
            ),
        ),
        Release(
            version = "2.8.4",
            ...
            date = "June 2026",
            items = listOf(
                "New: a clear in-app guide to how NOOP's three daily scores - Charge, Effort and Rest - are calculated, and how they differ from WHOOP's Recovery, Strain and Sleep. Tap the â“˜ on any score on the Today screen, or open it any time from Settings â†’ About â†’ How your scores work. New here? A one-time card points you to it.",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Fixed (iPhone): the Workouts â†’ All Sessions table ran off the side of the screen, clipping the Sport, distance and source columns. It now scrolls sideways so every column is reachable, with a hint that you press-and-hold a workout to re-label, edit or delete it. Thanks @sebastianwoo (#183).",
            ),
        ),
        Release(
            version = "2.6.5",
            ...
            date = "June 2026",
            items = listOf(
                "New (iPhone and Android, experimental): Broadcast heart rate - your WHOOP 5.0/MG can now advertise its heart rate as a standard Bluetooth HR sensor, so a Garmin (Edge or watch), Zwift, Peloton or a gym machine can read it directly during a workout. Turn it on under Settings â†’ Experimental; it's opt-in and reversible, applied each time the strap connects. WHOOP 5.0/MG only (a Mac can't write to a 5/MG). Thanks @mornepousse (#181).",
            ),
        ),
        Release(
            version = "2.6.4",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Fixed (Mac and iOS): on a Bluetooth-only setup (no import), a day recorded as multiple sleep blocks showed only one block - the others were silently hidden. All blocks are now read from both sources, and a split day reads as ONE night: totals summed, the gap between blocks preserved in the hypnogram, and the \"N nights ago\" label counts days, not blocks. A night crossing midnight shows its span (e.g. \"Fri 13 â†’ Sat 14 Jun\"). Implemented from PR #173 - thanks @FrostDev7. Android equivalent follows shortly (its day totals were already correct).",
            ),
        ),
        Release(
            version = "2.3.1",
            ...
            items = listOf(
                ...
                "Fixed (Mac and iOS): the strap log no longer prints a stale \"layout v25/v26 â€¦ doesn't decode yet\" warning for layouts NOOP has decoded for a while. (#156, thanks @sudden-break)",
        ...
        Release(
            ...
            items = listOf(
                ...
                "New (Android): an \"All other apps\" toggle under Notifications â†’ Behaviour now buzzes your wrist for any app that isn't in the curated list (e.g. BeReal). Opt-in and off by default; quiet hours and only-when-worn still apply. (#168)",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "New (Mac, iOS and Android): the Sleep screen now lets you browse past nights - tap â—€/â–¶ on the hypnogram to step back through every recorded night, not just last night. (#160, thanks @FrostDev7)",
        ...
        Release(
            ...
            items = listOf(
                ...
                "Improved (Mac and Android): the AI Coach now also sees your SpOâ‚‚, respiration, skin-temperature deviation, steps and active energy in its summary - it previously had only recovery, strain, sleep, HRV and resting HR. (#124)",
            ),
        ),
        Release(
            version = "1.85",
            ...
            items = listOf(
                ...
                "New (Android): Vital Signs is now a first-class screen reachable from the menu - your resting HR, HRV, SpOâ‚‚, skin temperature and respiratory rate with their recent history and context in one place.",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Fixed (Android): the app could freeze and get killed (\"app isn't responding\") after a strap had banked a few nights of history. The nightly sleep analysis ran a slow scan ON the main thread; it's now off the main thread and the scan itself went from O(nÂ²) to O(n) - so the app stays responsive no matter how much history accumulates. (Mac was never affected - it already ran this off-screen.) (#125, thanks to a detailed field report)",
        ...
        Release(
            ...
            items = listOf(
                ...
                "New (Mac and Android): an Imperial / Metric units toggle in Settings - distance (km / mi), weight (kg / lb), height (cm / ft-in) and temperature (Â°C / Â°F), with a separate temperature override. Everything stays stored the same; this only changes how it's shown.",
            ),
        ),
        Release(
            version = "1.79",
        ...
        Release(
            ...
            items = listOf(
                ...
                "New (Android): a manual â€œSync nowâ€ button on the Live screen, plus an honest progress indicator while your strapâ€™s history is offloading.",
            ),
        ),
        Release(
            version = "1.77",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Improved (Android): the Live screen now says \"Syncing your strap historyâ€¦\" plainly while the strap is offloading, so it's obvious it's working - the brief status-pill change was easy to miss. (Mac already showed this clearly.)",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Fixed (Mac and Android): the \"Last Event\" line on the Live screen no longer shows an internal name when live heart rate starts (it used to read \"BLE_REALTIME_HRâ€¦\"). It now only shows meaningful strap events - wrist on/off, double-tap, battery, and so on.",
        ...
        Release(
            ...
            items = listOf(
                ...
                "New (Mac and Android): a \"Â· Charging\" indicator on the battery pill when your strap is on the charger.",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "New (Android, opt-in): NOOP can now write the nightly metrics it computes from your strap - resting heart rate, HRV, SpOâ‚‚ and respiratory rate - into Health Connect, so other apps can use them. Off by default; flip \"Share back to Health Connect\" in Data Sources and grant the write permissions. Only NOOP's own computed values are written (imported data is never echoed back), and re-writes update in place rather than stacking duplicates. Mac: version bump only.",
            ),
        ),
        Release(
            version = "1.58",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "New (Android): a home-screen widget. Today's recovery - coloured green, amber or red by the usual bands - plus live heart rate and strap battery, at a glance without opening the app. It updates from the background connection (or while the app is open), shows when it last heard from the strap, and tapping it opens NOOP. Long-press your home screen â†’ Widgets â†’ NOOP to add it. Honest-blank until NOOP has learned enough nights to score you. Mac: version bump only.",
            ),
        ),
        Release(
            version = "1.56",
        ...
        Release(
            ...
            items = listOf(
                ...
                "New: a pulsing \"Syncing strap historyâ€¦\" indicator on Today, Sleep and Intelligence while the strap's history is offloading - with a live chunk count - so a half-loaded screen (\"No nights here yet\") reads as in-progress, not final. The Live pill shows \"Bonded Â· syncing\" too. Mac and Android (#77).",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Fixed: Spanish WHOOP CSV exports now import. A Spanish export translates both the column headers (PuntuaciÃ³n de recuperaciÃ³n, Variabilidad de la frecuencia cardÃ­aca, and so on) and some filenames (sueÃ±o.csv, entrenamientos.csv), so it used to match nothing and reported \"Imported 0 items.\" NOOP now maps the Spanish columns to their canonical fields and recognises the Spanish filenames, so recovery, strain, sleep, HRV and the rest come through correctly. Mac and Android. Thanks to a reporter who supplied a real export's headers (#76) - the same way German was added.",
            ),
        ),
        Release(
            version = "1.48",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Small follow-up: when Check for updates finds a newer version, it now shows what's new in it right there in Settings â†’ About - so you can see what you're getting before you tap Download.",
            ),
        ),
        Release(
            version = "1.40",
            ...
            date = "June 2026",
            items = listOf(
                "New: a Check for updates button in Settings â†’ About. It asks GitHub for the latest version and, if there's a newer one, links you straight to the download - so you're not stuck on an old build. It runs ONLY when you tap it: no background checks, no auto-updating, and nothing about you is sent - it just reads the latest version number. Manual, and in your control.",
            ),
        ),
        Release(
            version = "1.39",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Decoding progress (WHOOP 5.0): NOOP now reads skin temperature, motion/activity and wrist-contact from your 5.0's stored history - each verified against real data (e.g. ~30.6 Â°C on the wrist, dropping to room temperature off it) and only stored when it's physically sensible. These are building blocks toward on-device 5.0 sleep and recovery; nothing changes on screen yet.",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Changed (Android): the strap connection log is no longer copied to the phone's system log (logcat) by default. A normal user has no reason to write the Bluetooth connection log to the device-wide log, so it's now off unless you turn on Settings â†’ Strap â†’ \"Debug logging\" (there for developers watching a session over adb). The in-app log and \"Share strap log\" export work exactly as before, so bug reports are unaffected.",
            ),
        ),
        Release(
            version = "1.19",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Mac: you can now export the strap log - Copy / Saveâ€¦ on the Live screen's strap log - so Mac users can attach it to a bug report too (Android has had this since 1.6).",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "New on Android: Settings â†’ Strap â†’ â€œShare strap logâ€ exports the connection log to a file you can attach to a bug report. If your strap won't connect or behaves oddly, this is the single most helpful thing you can send.",
                "Fixed on Android: the â€œWornâ€ status always reading Off. It now assumes you're wearing the strap until the strap says otherwise, matching the Mac app.",
            ),
        ),
        Release(
            version = "1.5",
        ...
        Release(
            ...
            items = listOf(
                ...
                "New â€œKeep connected in the backgroundâ€ toggle in Settings â†’ Strap (on by default). Turn it off and NOOP disconnects whenever you close the app.",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "New Readiness card on Today - a â€œshould you push today?â€ read from your own history: HRV vs your baseline, resting-heart-rate drift, sleeping respiratory rate, training-load balance and training variety, rolled into one headline.",
                ...
                "Opt-in WHOOP 5/MG protocol probes under Settings â†’ Experimental, for 5/MG owners who want to help map the protocol.",
                "German and other localized WHOOP exports now import with real values, not blanks.",
                "Fixed the WHOOP 5/MG â€œstuck connectingâ€ state and the macOS â€œChoose exportâ€ button.",
            ),
        ),
        Release(
            version = "1.1",
     ...
     * â€œwhat is this and what should I expectâ€ story, so people don't have to go read GitHub.
     */
