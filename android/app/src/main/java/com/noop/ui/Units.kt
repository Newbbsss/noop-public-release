...
object UnitFormatter {
    ...
    /**
     * Format a stored 0–100 Effort value for display on the selected scale.
     * SHIP #175 — NOOP 0–100 scores as int; WHOOP 0–21 keeps one decimal for the dual scale.
     */
    fun effortDisplay(value: Double, scale: EffortScale): String =
        if (scale == EffortScale.WHOOP) {
