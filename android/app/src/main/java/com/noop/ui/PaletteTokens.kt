...
val LightTokens = PaletteTokens(
    // Deeper cool-gray paper (chroma toward brand blue, not cream/sand AI cluster).
    // Gilbert: prior E8/white paper + day-cycle wash was too bright / unusable — mid-tone canvas,
    // soft raised cards (not pure white), stronger hairlines for readable contrast everywhere.
    surfaceBase = Color(0xFFD0CEC9), surfaceRaised = Color(0xFFECEAE6), surfaceOverlay = Color(0xFFE4E2DE),
    surfaceInset = Color(0xFFC0BEB9), hairline = Color(0xFFA8A59E), hairlineStrong = Color(0xFF85827B),
    textPrimary = Color(0xFF121820), textSecondary = Color(0xFF343C48), textTertiary = Color(0xFF505864),
    glowAmbient = Color(0xFFD0CCC4),
    // Light chrome accent = deep brand blue (fills stay bright; strokes/text use deep).
    accent = Color(0xFF234F9E), accentHover = Color(0xFF1C3F80), accentMuted = Color(0xFFD4DEEC), focusRing = Color(0xFF2F6FCB),
    // Deepened WHOOP recovery (red→green) — gold-only ramp failed track/fill contrast on paper (#235).
    recovery000 = Color(0xFFCB3A2F), recovery030 = Color(0xFFD87328), recovery055 = Color(0xFFCFA528),
    recovery078 = Color(0xFF74A53A), recovery100 = Color(0xFF2E9E4F),
    strain000 = Color(0xFF5E92D6), strain033 = Color(0xFF3A74C4), strain066 = Color(0xFF284F9C), strain100 = Color(0xFF1C3E80),
    sleepAwake = Color(0xFF8C95A3), sleepLight = Color(0xFF3A80D6), sleepDeep = Color(0xFF203E73), sleepREM = Color(0xFF5790DA),
    zone1 = Color(0xFF3A80D6), zone2 = Color(0xFF2E92B4), zone3 = Color(0xFFC28E26), zone4 = Color(0xFFC2792E), zone5 = Color(0xFFC84E1E),
    statusPositive = Color(0xFF1F8A48), statusWarning = Color(0xFFB07A18), statusCritical = Color(0xFFC84E1E),
    metricCyan = Color(0xFF2E92B4), metricPurple = Color(0xFF3A80D6), metricAmber = Color(0xFFB07A18), metricRose = Color(0xFFC84E1E),
    // Domain worlds match dark semantics, deepened for paper.
    chargeColor = Color(0xFF1F8A48), chargeDeep = Color(0xFF146636), chargeBright = Color(0xFF3CB86A), chargeGlow = Color(0xFF1F8A48),
    ...
    titaniumTop = Color(0xFFC8CDD4), titaniumMid = Color(0xFFA8B0B8), titaniumLow = Color(0xFF889098), titaniumDeep = Color(0xFF5A626A),
    tipCore = Color(0xFF121820),
)
