...
class HrvAnalyzerGateTest {
    ...
    @Test
    fun feelRmssdMs_needsThreeIntervals() {
        assertNull(HrvAnalyzer.feelRmssdMs(listOf(800, 810)))
        val v = HrvAnalyzer.feelRmssdMs(listOf(800, 810, 790, 820))
        assertNotNull(v)
        assertEquals(true, v!! > 0.0)
    }
