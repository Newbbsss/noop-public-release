...
class PushGateTests {
    ...
    fun snap(
        ...
        connected = connected,
        updatedAtMs = at,
        stressTipTenths = stressTipTenths,
    )
    ...
    @Test
    fun stressTipChangeIsAdmittedImmediately() {
        PushGate.markPushed(snap(stressTipTenths = null, at = 1_000))
        assertTrue(PushGate.admit(snap(stressTipTenths = 9, at = 2_000)))
    }
}
