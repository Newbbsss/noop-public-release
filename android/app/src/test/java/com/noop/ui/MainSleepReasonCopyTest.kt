 ...
 * foundation [SleepStageTotals.MainNightReason] branch, and the {DUR} fill. Keep Android + iOS aligned
 * when changing strings; "this night" (not calendar "today") so historical ◀/▶ nights stay honest.
 *
...
class MainSleepReasonCopyTest {
    ...
    fun onlyBlockCopy() {
        ...
        assertEquals("This is your only sleep block this night.", reason)
    }
